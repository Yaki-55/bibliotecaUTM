...
export declare const editState: (
  arg1: {
    client: SanityClient
    schema: Schema
    serverActionsEnabled?: boolean | undefined
  },
  arg2: IdPair,
  arg3: string,
...
export declare const StatusButton: ForwardRefExoticComponent<
  (StatusButtonProps & Omit<HTMLProps<HTMLButtonElement>, 'title' | 'disabled' | 'ref' | 'size'>) &
    RefAttributes<HTMLButtonElement>
>
...
export declare const TooltipOfDisabled: ForwardRefExoticComponent<
  Omit<TooltipProps_2, 'arrow' | 'shadow' | 'padding'> & {
