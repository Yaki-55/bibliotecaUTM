...
}), TooltipDelayGroupProvider = (props) => /* @__PURE__ */ jsx(TooltipDelayGroupProvider$1, { delay: TOOLTIP_DELAY_PROPS, children: props.children }), LocaleContext = createContext(void 0);
...
const HOURS_24 = range(0, 24), ARROW_KEYS = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"], TAIL_WEEKDAYS = [1, 2, 3, 4, 5, 6], getWeekStartsOfMonth = (date, weekStartsOn) => {
...
function CalendarMonth(props) {
  ...
  return /* @__PURE__ */ jsx(Box, { "aria-hidden": props.hidden || !1, "data-ui": "CalendarMonth", children: /* @__PURE__ */ jsxs(Grid, { gap: 1, style: { gridTemplateColumns: "repeat(7, minmax(44px, 46px))" }, children: [
    weekDayNames.map((weekday) => /* @__PURE__ */ jsx(Box, { paddingY: 2, children: /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", style: { textAlign: "center" }, children: weekday }) }, weekday)),
...
const features = {
  dayPresets: !1,
  timePresets: !1
}, LazyTextInput = forwardRef(function({ onChange, onBlur, onKeyPress, value, ...rest }, forwardedRef) {
  const [inputValue, setInputValue] = useState(), handleChange = useCallback((event) => {
    setInputValue(event.currentTarget.value);
  }, []), checkEvent = useCallback(
    (event) => {
  ...
  const { onChange, ...restProps } = props, handleChange = useCallback(
    (event) => {
  ...
  const ref = useForwardedRef(forwardedRef), focusCurrentWeekDay = useCallback(() => {
    ...
    (event) => {
      ...
      event.key === "ArrowUp" && onFocusedDateChange(addDays(focusedDate, -7)), event.key === "ArrowDown" && onFocusedDateChange(addDays(focusedDate, 7)), event.key === "ArrowLeft" && onFocusedDateChange(addDays(focusedDate, -1)), event.key === "ArrowRight" && onFocusedDateChange(addDays(focusedDate, 1)), (_b = (_a = ref.current) == null ? void 0 : _a.querySelector("[data-preserve-focus]")) == null || _b.focus();
    },
    ...
    selectTime && /* @__PURE__ */ jsxs(Box, { padding: 2, style: { borderTop: "1px solid var(--card-border-color)" }, children: [
      /* @__PURE__ */ jsxs(Flex, { align: "center", children: [
        /* @__PURE__ */ jsxs(Flex, { align: "center", flex: 1, children: [
          ...
          /* @__PURE__ */ jsx(Box, { paddingX: 1, children: /* @__PURE__ */ jsx(Text, { size: 1, children: ":" }) }),
          /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(
            Select,
            {
        ...
        /* @__PURE__ */ jsx(Box, { marginLeft: 2, children: /* @__PURE__ */ jsx(Button, { text: labels.setToCurrentTime, mode: "bleed", onClick: handleNowClick }) })
      ] }),
...
function CalendarMonthSelect(props) {
  ...
  return /* @__PURE__ */ jsx(Flex, { flex: 1, gap: 1, children: /* @__PURE__ */ jsx(Box, { flex: 1, children: /* @__PURE__ */ jsx(Select, { fontSize: 1, radius: 2, value, onChange, padding: 2, children: monthNames.map((monthName, i) => (
    // eslint-disable-next-line react/no-array-index-key
    /* @__PURE__ */ jsx("option", { value: i, children: monthName }, i)
  )) }) }) });
}
function CalendarYearSelect(props) {
  const { moveFocusedDate, onChange, value, labels } = props, handlePrevYearClick = useCallback(() => moveFocusedDate(-12), [moveFocusedDate]), handleNextYearClick = useCallback(() => moveFocusedDate(12), [moveFocusedDate]);
  return /* @__PURE__ */ jsxs(Flex, { gap: 1, children: [
    ...
    /* @__PURE__ */ jsx(YearInput, { value, onChange, radius: 0, style: { width: 48 } }),
    /* @__PURE__ */ jsx(
      Button,
      {
...
const DatePicker = forwardRef(function(props, ref) {
  const { value = /* @__PURE__ */ new Date(), onChange, calendarLabels, ...rest } = props, [focusedDate, setFocusedDay] = useState(), handleSelect = useCallback(
    (nextDate) => {
...
export {
  ...
  MenuItem as b,
  MenuButton as c,
  TooltipDelayGroupProvider as d,
  LazyTextInput as e,
  DatePicker as f,
  generateHelpUrl as g,
  getCalendarLabels as h,
  isValidDate as i,
  Tab as j,
  getJsonStream as k,
  useCurrentLocale as u
};
