...
import { g as generateHelpUrl, B as Button } from "./generate-help-url.esm.mjs";
...
const paneMap = {
  ...
  document: lazy(() => import("./pane.mjs").then(function(n) {
    return n.aa;
  })),
  documentList: lazy(() => import("./pane.mjs").then(function(n) {
    return n.ab;
  })),
