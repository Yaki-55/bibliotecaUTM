...
import { $ as usePaneLayout, a3 as ChildLink, Z as BackLink, a4 as ReferenceChildLink, a5 as ParameterizedLink, n as PaneRouterContext, R as useStructureTool, a6 as LOADING_PANE, Q as structureLocaleNamespace, o as SerializeError, _ as Pane, X as PaneHeader, a1 as PaneContent, a7 as LoadingPane, P as PaneLayout, a8 as setActivePanes, S as StructureToolProvider } from "./pane.esm.js";
...
import { g as generateHelpUrl, B as Button } from "./generate-help-url.esm.esm.js";
...
function PaneRouterProvider(props) {
  const { children, flatIndex, index, params, payload, siblingIndex } = props, { navigate, navigateIntent, resolvePathFromState } = useRouter(), routerState = useRouterState(), { panes, expand } = usePaneLayout(), routerPaneGroups = useMemo(
    () => (routerState == null ? void 0 : routerState.panes) || emptyArray,
    [routerState == null ? void 0 : routerState.panes]
  ), lastPane = useMemo(() => panes == null ? void 0 : panes[panes.length - 2], [panes]), groupIndex = index - 1, createNextRouterState = useCallback(
    (modifier) => {
  ...
  ), modifyCurrentGroup = useCallback(
    (modifier) => {
  ...
  ), createPathWithParams = useCallback(
    (nextParams) => {
    ...
    [modifyCurrentGroup, siblingIndex]
  ), handleEditReference = useCallback(
  ...
  return /* @__PURE__ */ jsx(PaneRouterContext.Provider, { value: ctx, children });
}
...
class PaneResolutionError extends Error {
  constructor({ message, context, helpId, cause }) {
    super(message), __publicField(this, "cause"), __publicField(this, "context"), __publicField(this, "helpId"), this.context = context, this.helpId = helpId, this.cause = cause;
  }
}
...
const isPromise = (thing) => !!thing && typeof (thing == null ? void 0 : thing.then) == "function", isSerializable = (thing) => isRecord(thing) ? typeof thing.serialize == "function" : !1, rethrowWithPaneResolutionErrors = (next) => (unresolvedPane, context, flatIndex) => {
  try {
...
function useRouterPanesStream() {
  const routerStateSubject = useMemo(() => new ReplaySubject(1), []), routerPanes$ = useMemo(
...
function useResolvedPanes() {
  ...
  if (error)
    throw error;
  const { structureContext, rootPaneNode } = useStructureTool(), [data, setData] = useState({
    paneDataItems: [],
    resolvedPanes: [],
    routerPanes: []
...
const EMPTY_RECORD = {}, IntentResolver = memo(function() {
  ...
  ), { rootPaneNode, structureContext } = useStructureTool(), documentStore = useDocumentStore(), [error, setError] = useState(null);
  if (error)
    throw error;
  return useEffect(() => {
    if (maybeIntent) {
...
function StructureError({ error }) {
  if (!(error instanceof PaneResolutionError))
    throw error;
  const { cause } = error, { t } = useTranslation(structureLocaleNamespace), stack = (cause == null ? void 0 : cause.stack) || error.stack, showStack = stack && !(cause instanceof SerializeError) && !error.message.includes("Module build failed:"), path = cause instanceof SerializeError ? cause.path : [], helpId = cause instanceof SerializeError && cause.helpId || error.helpId, handleReload = useCallback(() => {
    window.location.reload();
  }, []);
  return /* @__PURE__ */ jsx(Card, { height: "fill", overflow: "auto", padding: 4, sizing: "border", tone: "critical", children: /* @__PURE__ */ jsxs(Container, { children: [
    /* @__PURE__ */ jsx(Heading, { as: "h2", children: t("structure-error.header.text") }),
    /* @__PURE__ */ jsxs(Card, { marginTop: 4, padding: 4, radius: 2, overflow: "auto", shadow: 1, tone: "inherit", children: [
      path.length > 0 && /* @__PURE__ */ jsxs(Stack, { space: 2, children: [
        /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: t("structure-error.structure-path.label") }),
        /* @__PURE__ */ jsx(Code, { children: path.slice(1).map((segment, i) => (
          // eslint-disable-next-line react/no-array-index-key
          /* @__PURE__ */ jsx(PathSegment, { children: segment }, `${segment}-${i}`)
        )) })
      ] }),
      /* @__PURE__ */ jsxs(Stack, { marginTop: 4, space: 2, children: [
        /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: t("structure-error.error.label") }),
        /* @__PURE__ */ jsx(Code, { children: showStack ? formatStack(stack) : error.message })
      ] }),
      helpId && /* @__PURE__ */ jsx(Box, { marginTop: 4, children: /* @__PURE__ */ jsx(Text, { children: /* @__PURE__ */ jsx("a", { href: generateHelpUrl(helpId), rel: "noopener noreferrer", target: "_blank", children: t("structure-error.docs-link.text") }) }) }),
...
function UnknownPane(props) {
  const { isSelected, pane, paneKey } = props, type = isRecord(pane) && pane.type || null, { t } = useTranslation(structureLocaleNamespace);
  return /* @__PURE__ */ jsxs(Pane, { id: paneKey, selected: isSelected, children: [
    /* @__PURE__ */ jsx(PaneHeader, { title: t("panes.unknown-pane-type.title") }),
    /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsx(Box, { padding: 4, children: typeof type == "string" ? /* @__PURE__ */ jsx(Text, { as: "p", muted: !0, children: /* @__PURE__ */ jsx(
      Translate,
      {
        t,
    ...
    ) }) : /* @__PURE__ */ jsx(Text, { as: "p", muted: !0, children: /* @__PURE__ */ jsx(Translate, { t, i18nKey: "panes.unknown-pane-type.missing-type.text" }) }) }) })
  ] });
}
const paneMap = {
  component: lazy(() => import("./index.esm.js")),
  document: lazy(() => import("./pane.esm.js").then(function(n) {
    return n.aa;
  })),
  documentList: lazy(() => import("./pane.esm.js").then(function(n) {
    return n.ab;
  })),
  list: lazy(() => import("./index.esm2.js"))
}, StructureToolPane = memo(
  function(props) {
    const {
      active,
      childItemId,
    ...
    return /* @__PURE__ */ jsx(
      PaneRouterProvider,
      {
        ...
        payload,
        siblingIndex,
        children: /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(LoadingPane, { paneKey, path, selected }), children: /* @__PURE__ */ jsx(
          PaneComponent,
          {
...
function NoDocumentTypesScreen() {
  ...
  return /* @__PURE__ */ jsx(Card, { height: "fill", children: /* @__PURE__ */ jsx(Flex, { align: "center", height: "fill", justify: "center", padding: 4, sizing: "border", children: /* @__PURE__ */ jsx(Container, { width: 0, children: /* @__PURE__ */ jsx(Card, { padding: 4, radius: 2, shadow: 1, tone: "caution", children: /* @__PURE__ */ jsxs(Flex, { children: [
    ...
    /* @__PURE__ */ jsxs(Stack, { flex: 1, marginLeft: 3, space: 3, children: [
      /* @__PURE__ */ jsx(Text, { as: "h1", size: 1, weight: "medium", children: t("no-document-types-screen.title") }),
      /* @__PURE__ */ jsx(Text, { as: "p", muted: !0, size: 1, children: t("no-document-types-screen.subtitle") }),
      /* @__PURE__ */ jsx(Text, { as: "p", muted: !0, size: 1, children: /* @__PURE__ */ jsx(
        "a",
        {
...
const DocumentTitle = (props) => {
  const { documentId, documentType } = props, editState = useEditState(documentId, documentType), schema = useSchema(), { t } = useTranslation(structureLocaleNamespace), isNewDocument = !(editState != null && editState.published) && !(editState != null && editState.draft), documentValue = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published), schemaType = schema.get(documentType), { value, isLoading: previewValueIsLoading } = unstable_useValuePreview({
    enabled: !0,
    schemaType,
    value: documentValue
  ...
  return isLoadingPane(lastPane) ? /* @__PURE__ */ jsx(PassthroughTitle, {}) : isDocumentPane(lastPane) ? lastPane != null && lastPane.title ? /* @__PURE__ */ jsx(PassthroughTitle, { title: lastPane.title }) : /* @__PURE__ */ jsx(DocumentTitle, { documentId: lastPane.options.id, documentType: lastPane.options.type }) : /* @__PURE__ */ jsx(PassthroughTitle, { title: lastPane == null ? void 0 : lastPane.title });
};
...
const StyledPaneLayout = styled(PaneLayout)`
  min-height: 100%;
  min-width: 320px;
`, isSaveHotkey = isHotkey("mod+s"), StructureTool = memo(function({ onPaneChange }) {
  var _a;
  const { push: pushToast } = useToast(), schema = useSchema(), { layoutCollapsed, setLayoutCollapsed } = useStructureTool(), { paneDataItems, resolvedPanes } = useResolvedPanes(), isResolvingIntent = useRouterState(
    ...
    sanity: { media }
  } = useTheme(), [portalElement, setPortalElement] = useState(null), handleRootCollapse = useCallback(() => setLayoutCollapsed(!0), [setLayoutCollapsed]), handleRootExpand = useCallback(() => setLayoutCollapsed(!1), [setLayoutCollapsed]);
  return useEffect(() => {
    resolvedPanes.length && onPaneChange(resolvedPanes);
  }, [onPaneChange, resolvedPanes]), useEffect(() => {
  ...
  }, [pushToast]), (_a = schema._original) != null && _a.types.some(_isCustomDocumentTypeDefinition) ? /* @__PURE__ */ jsxs(PortalProvider, { element: portalElement || null, children: [
    /* @__PURE__ */ jsxs(
      StyledPaneLayout,
      {
        flex: 1,
        ...
        children: [
          paneDataItems.map(
            ({
              ...
              siblingIndex,
              selected
            }) => /* @__PURE__ */ jsx(Fragment, { children: pane === LOADING_PANE ? /* @__PURE__ */ jsx(LoadingPane, { paneKey, path, selected }) : /* @__PURE__ */ jsx(
              StructureToolPane,
              {
                active,
                groupIndex,
          ...
          paneDataItems.length <= 1 && isResolvingIntent && /* @__PURE__ */ jsx(LoadingPane, { paneKey: "intent-resolver" })
        ]
      }
    ),
    /* @__PURE__ */ jsx(StructureTitle, { resolvedPanes }),
    /* @__PURE__ */ jsx("div", { "data-portal": "", ref: setPortalElement })
  ] }) : /* @__PURE__ */ jsx(NoDocumentTypesScreen, {});
});
function StructureToolBoundary({ tool: { options } }) {
  ...
  useEffect(() => (setActivePanes([]), () => setActivePanes([])), []);
  const [{ error }, setError] = useState({ error: null });
  return error ? /* @__PURE__ */ jsx(StructureError, { error }) : /* @__PURE__ */ jsx(ErrorBoundary, { onCatch: setError, children: /* @__PURE__ */ jsx(SourceProvider, { name: source || firstSource.name, children: /* @__PURE__ */ jsxs(StructureToolProvider, { defaultDocumentNode, structure, children: [
    /* @__PURE__ */ jsx(StructureTool, { onPaneChange: setActivePanes }),
