...
import { T as Tooltip, D as Dialog, d as TooltipDelayGroupProvider, B as Button, M as MenuGroup, b as MenuItem, c as MenuButton, P as Popover, C as ConditionalWrapper, j as Tab, g as generateHelpUrl, h as getCalendarLabels, f as DatePicker, k as getJsonStream } from "./generate-help-url.esm.esm.js";
...
}), CommentsUpsellContext = createContext(null), FEATURE$1 = "comments", TEMPLATE_OPTIONS$1 = { interpolate: /{{([\s\S]+?)}}/g }, BASE_URL$1 = "www.sanity.io";
  ...
  useEffect(() => {
    const sub = client.observable.request({
      ...
      next: (data) => {
        if (data)
          try {
            const ctaUrl = template(data.ctaButton.url, TEMPLATE_OPTIONS$1);
            data.ctaButton.url = ctaUrl({ baseUrl: BASE_URL$1, projectId });
            const secondaryUrl = template(data.secondaryButton.url, TEMPLATE_OPTIONS$1);
...
const structureLocaleNamespace = "structure", structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources.esm2.js")
});
...
}), editorSchemaType = schema.get("body"), Span$2 = styled.span(({ theme }) => {
  var _a, _b, _c;
...
function MentionInlineBlock(props) {
  ...
  return !user || loading ? /* @__PURE__ */ jsx(
    ...
    Tooltip,
    {
      ...
      children: /* @__PURE__ */ jsxs(Span$2, { "data-selected": selected, "data-active": (currentUser == null ? void 0 : currentUser.id) === userId, children: [
        "@",
        user.displayName
      ] })
    }
  ...
  return /* @__PURE__ */ jsx(Container, { width: 1, children: /* @__PURE__ */ jsx(Box, { marginBottom: 6, children: /* @__PURE__ */ jsxs(Card, { radius: 3, overflow: "hidden", border: !0, children: [
    ...
    /* @__PURE__ */ jsxs(Box, { padding: 3, marginTop: 2, children: [
      ...
      /* @__PURE__ */ jsxs(Flex, { gap: 2, justify: "flex-end", marginTop: 5, children: [
        data.secondaryButton.text && /* @__PURE__ */ jsx(
          Button,
          {
            mode: "bleed",
            text: data.secondaryButton.text,
...
const FEEDBACK_FORM_LINK$1 = "https://snty.link/comments-beta-feedback", Span$1 = styled.span`
  margin-right: 0.2em;
`, Link$1 = styled.a`
  white-space: nowrap;
...
function CommentsInspectorFeedbackFooter() {
  ...
  return /* @__PURE__ */ jsx(FooterCard, { padding: 4, children: /* @__PURE__ */ jsxs(Text, { muted: !0, size: 1, children: [
    ...
    " ",
    /* @__PURE__ */ jsxs(Link$1, { href: FEEDBACK_FORM_LINK$1, target: "_blank", rel: "noreferrer", children: [
      /* @__PURE__ */ jsxs(Span$1, { children: [
...
const DocumentPaneProvider = memo((props) => {
  const { children, index, pane: pane2, paneKey, onFocusPath } = props, schema2 = useSchema(), templates = useTemplates(), {
    ...
    title = null,
    views: viewsProp = []
  } = pane2, paneOptions = useUnique(options), documentIdRaw = paneOptions.id, documentId = getPublishedId(documentIdRaw), documentType = options.type, params = useUnique(paneRouter.params) || EMPTY_PARAMS$2, panePayload = useUnique(paneRouter.payload), { templateName, templateParams } = useMemo(
  ...
  ), focusPathRef = useRef(focusPath), openPathRef = useRef([]), activeViewId = params.view || views2[0] && views2[0].id || null, [timelineMode, setTimelineMode] = useState("closed"), [timelineError, setTimelineError] = useState(null), timelineStore = useTimelineStore({
    documentId,
    documentType,
  ...
  const setOpenPath = useCallback(
    ...
    (nextFocusPath) => {
      deepEquals(focusPathRef.current, nextFocusPath) || (setFocusPath(nextFocusPath), focusPathRef.current = nextFocusPath, openPathRef.current = nextFocusPath, onFocusPath == null || onFocusPath(nextFocusPath)), presenceStore.setLocation([
        {
          type: "document",
          documentId,
          path: nextFocusPath,
  ...
  return useEffect(() => {
    ...
    if (ready && params.path) {
      ...
      disableBlurRef.current = !0, setFocusPath(pathFromUrl), deepEquals(openPathRef.current, pathFromUrl) || (openPathRef.current = pathFromUrl, setOpenPath(pathFromUrl)), deepEquals(focusPathRef.current, pathFromUrl) || (focusPathRef.current = pathFromUrl, onFocusPath == null || onFocusPath(pathFromUrl));
      const timeout = setTimeout(() => {
...
function DueByChange({ date }) {
  ...
  return /* @__PURE__ */ jsx(Strong, { children: /* @__PURE__ */ jsx(NoWrap, { children: formattedDate }) });
}
  ...
  function(props) {
    ...
    return /* @__PURE__ */ jsxs(Flex, { gap: 1, children: [
      ...
      /* @__PURE__ */ jsxs(Text, { muted: !0, size: 1, children: [
        ...
        " \u2022",
        " ",
        /* @__PURE__ */ jsx(Tooltip, { content: formattedDate, placement: "top-end", children: /* @__PURE__ */ jsx(NoWrap, { children: /* @__PURE__ */ jsx("time", { dateTime: formattedDate, children: timeAgo }) }) })
      ] })
    ] });
  },
  (prevProps, nextProps) => prevProps.activity.timestamp === nextProps.activity.timestamp
), TasksEnabledContext = createContext(null);
function TasksEnabledProvider({ children }) {
  var _a;
  const { enabled, isLoading } = useFeatureEnabled("sanityTasks"), isWorkspaceEnabled = (_a = useWorkspace().tasks) == null ? void 0 : _a.enabled, value = useMemo(() => !isWorkspaceEnabled || isLoading ? {
    enabled: !1,
    mode: null
  } : {
    enabled: !0,
...
const TasksNavigationContext = createContext(null), TaskCreated = defineEvent({
  name: "Task Created",
  version: 1,
...
const TasksNavigationProvider = ({ children }) => {
  const [state2, dispatch] = useReducer(reducer, initialState), router2 = useRouter(), toast = useToast(), telemetry = useTelemetry(), setViewMode = useCallback((viewMode) => {
  ...
  }, [searchParamsAsString, telemetry]), /* @__PURE__ */ jsx(
...
function TasksProvider(props) {
  const { children } = props, [activeDocument, setActiveDocument] = useState(null), { data = EMPTY_ARRAY$4, isLoading } = useTasksStore({}), debouncedSetActiveDocument = useCallback(debounce(setActiveDocument, 1e3), []), value = useMemo(
    () => ({
      activeDocument,
...
function TasksUserAvatar(props) {
  ...
  return loading ? /* @__PURE__ */ jsx(AvatarSkeleton, { $size: size, animated: !0 }) : !user || !loadedUser ? /* @__PURE__ */ jsx(AvatarRoot, { $size: size, $border: border, children: /* @__PURE__ */ jsx(Text, { size, children: /* @__PURE__ */ jsx(UserIcon, {}) }) }) : /* @__PURE__ */ jsx(
    Tooltip,
    {
      ...
      placement: "top-end",
      children: /* @__PURE__ */ jsx(AvatarRoot, { $size: size, $removeBg: !!(loadedUser != null && loadedUser.imageUrl), children: /* @__PURE__ */ jsx(
        UserAvatar,
        {
          user: loadedUser,
          size,
...
const ActivityChildrenRoot = styled(Flex)`
  height: 100%;
`, ActivityItemChildrenContainer = styled.div`
  width: 100%;
`;
function ActivityItem({ avatarPaddingTop = 1, userId, children }) {
  return /* @__PURE__ */ jsxs(Flex, { children: [
    /* @__PURE__ */ jsx(Box, { marginRight: 3, paddingTop: avatarPaddingTop, children: /* @__PURE__ */ jsx(TasksUserAvatar, { user: { id: userId }, size: 0 }) }),
    /* @__PURE__ */ jsx(ActivityChildrenRoot, { align: "center", flex: 1, children: /* @__PURE__ */ jsx(ActivityItemChildrenContainer, { children }) })
  ] });
}
function TasksActivityCommentInput(props) {
  const { mentionOptions, currentUser, onSubmit } = props, { mode } = useTasksEnabled(), [value, setValue] = useState(null), editorRef = useRef(null), hasValue = useMemo(() => hasCommentMessageValue(value), [value]), handleChange = useCallback((nextValue) => {
    setValue(nextValue);
  }, []), handleSubmit = useCallback(() => {
  ...
  return /* @__PURE__ */ jsx(ActivityItem, { userId: currentUser.id, avatarPaddingTop: 3, children: /* @__PURE__ */ jsx(Card, { tone: "transparent", radius: 3, padding: 2, children: /* @__PURE__ */ jsx(
    CommentInput,
    {
      withAvatar: !1,
      currentUser,
...
const COMMENTS_LIST_ITEM_AVATAR_CONFIG = {
  ...
  replyAvatar: !0,
  avatarSize: 0
}, CommentListItemRoot = styled.div((props) => {
  const theme = getTheme_v2(props.theme);
  return css`
    [data-ui='comments-list-item'] {
...
function TasksActivityCommentItem(props) {
  ...
  return /* @__PURE__ */ jsx(ActivityItem, { userId: parentComment.authorId, avatarPaddingTop: 3, children: /* @__PURE__ */ jsx(CommentListItemRoot, { children: /* @__PURE__ */ jsx(
    CommentsListItem,
    {
      ...props,
...
`, TasksActivityCreatedAt = memo(
  function(props) {
    ...
    return /* @__PURE__ */ jsx(ActivityItem, { userId: authorId, children: /* @__PURE__ */ jsx(Flex, { align: "center", paddingTop: 1, children: /* @__PURE__ */ jsxs(Text, { size: 1, muted: !0, children: [
      ...
      " \u2022",
      " ",
      /* @__PURE__ */ jsx(Tooltip, { content: formattedDate, placement: "top-end", children: /* @__PURE__ */ jsx(NoWrap, { children: /* @__PURE__ */ jsx("time", { dateTime: createdAt, children: timeAgo }) }) })
    ] }) }) });
  },
...
function TasksSubscriberAvatars(props) {
  const { subscriberIds: subscriberIdsProp } = props, subscriberIds = useMemo(() => (subscriberIdsProp == null ? void 0 : subscriberIdsProp.filter(Boolean)) || EMPTY_ARRAY$3, [subscriberIdsProp]);
...
function AssigneeEditFormField(props) {
  ...
  return /* @__PURE__ */ jsx(
    AssigneeSelectionMenu,
    {
      onSelect,
      value,
      menuButton: /* @__PURE__ */ jsx(StyledButton, { mode: "ghost", padding: 0, children: /* @__PURE__ */ jsx(
        Tooltip,
        {
...
function DescriptionInput(props) {
  ...
  }, [value, setTextboxHeight, rootRef]), currentUser ? /* @__PURE__ */ jsx(DescriptionInputRoot, { $mode: mode, ref: handleSetRootRef, $minHeight: textBoxScrollHeight, children: /* @__PURE__ */ jsx(
    CommentInput,
    {
      expandOnFocus: !1,
      currentUser,
...
const StatusMenuButton = forwardRef(function(props, ref) {
  var _a;
  const { t } = useTranslation(tasksLocaleNamespace), { value, options, ...rest } = props, selectedOption = options.find((option) => option.value === value), icon = (_a = TASK_STATUS.find((status) => status.value === value)) == null ? void 0 : _a.icon;
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...rest,
...
function StatusSelector(props) {
  const { value, onChange, options, path } = props, telemetry = useTelemetry(), handleStatusChange = useCallback(
    (next) => {
...
function FormCreate(props) {
  const { onChange } = props, {
    ...
    setActiveTab,
    state: { viewMode }
  } = useTasksNavigation(), toast = useToast(), telemetry = useTelemetry(), [createMore, setCreateMore] = useState(!1), handleCreateMore = useCallback(() => setCreateMore((p) => !p), []), value = props.value, onRemove = useCallback(() => {
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    props.renderDefault(props),
    /* @__PURE__ */ jsx(Box, { paddingY: 5, children: /* @__PURE__ */ jsxs(Flex, { paddingTop: 1, gap: 4, children: [
      value._rev && /* @__PURE__ */ jsx(
        Button,
        {
          onClick: handleRemove,
          mode: "bleed",
      ...
      /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 2, justify: "flex-end", flex: 1, children: [
...
function RemoveTaskDialog(props) {
  ...
  return showDialog ? /* @__PURE__ */ jsx(
    Dialog,
    {
      ...
      children: /* @__PURE__ */ jsx(Stack, { space: 3, children: /* @__PURE__ */ jsx(Text, { as: "p", children: t("dialog.remove-task.body") }) })
    }
  ) : null;
}
...
function FormActionsMenu({ id, value }) {
  const { setViewMode, handleCopyLinkToTask } = useTasksNavigation(), { mode } = useTasksEnabled(), telemetry = useTelemetry(), onTaskRemoved = useCallback(() => {
    setViewMode({ type: "list" }), telemetry.log(TaskRemoved);
  }, [setViewMode, telemetry]), removeTask = useRemoveTask({ id, onRemoved: onTaskRemoved }), duplicateTask = useCallback(() => {
    setViewMode({ type: "duplicate", duplicateTaskValues: value }), telemetry.log(TaskDuplicated);
  }, [setViewMode, telemetry, value]), { t } = useTranslation(tasksLocaleNamespace);
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
...
function FormEditInner(props) {
  ...
  return (_a = props.value) != null && _a._id ? /* @__PURE__ */ jsxs(Fragment$1, { children: [
    ...
    /* @__PURE__ */ jsx(Card, { borderTop: !0, marginTop: 3, children: /* @__PURE__ */ jsx(
      FirstRow,
      {
        paddingBottom: 3,
        paddingTop: 4,
...
function TasksNotificationTargetInner(props) {
  var _a, _b, _c;
  const { inputProps } = props, { onChange } = inputProps, { target, _id, context, _rev } = useFormValue([]), { title: workspaceTitle, basePath } = useWorkspace(), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), imageBuilder = useMemo(() => imageUrlBuilder(client), [client]), documentId = (_b = (_a = target == null ? void 0 : target.document) == null ? void 0 : _a._ref) != null ? _b : "", documentType = (_c = target == null ? void 0 : target.documentType) != null ? _c : "", { isLoading: previewValuesLoading, value } = useDocumentPreviewValues({
    documentId,
    documentType
  }), targetContentTitle = (value == null ? void 0 : value.title) || null, imageUrl = isImageSource(value == null ? void 0 : value.media) ? imageBuilder.image(value.media).width(96).height(96).url() : null, notificationTarget = useMemo(() => {
    var _a2, _b2;
  ...
  return useEffect(() => {
    documentId && documentType && previewValuesLoading || _rev && (deepEquals(context == null ? void 0 : context.notification, notificationTarget) || onChange(set(notificationTarget, ["notification"])));
...
function EmptyTasksListState() {
  const { activeDocument } = useTasks(), { mode } = useTasksEnabled(), {
    state: { activeTabId },
    setViewMode
  } = useTasksNavigation(), key = !activeDocument && activeTabId === "document" ? "noActiveDocument" : activeTabId, { heading, text } = EMPTY_TASK_LIST[key], { t } = useTranslation(tasksLocaleNamespace), handleTaskCreate = useCallback(() => {
  ...
  return /* @__PURE__ */ jsx(Root, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 3, align: "center", flex: 1, justify: "center", children: [
    /* @__PURE__ */ jsx(AnimatedText, { size: 1, weight: "semibold", children: t(heading) }, key),
    /* @__PURE__ */ jsx(Box, { paddingBottom: 6, paddingTop: 1, children: /* @__PURE__ */ jsx(AnimatedText, { size: 1, align: "center", children: t(text) }, key) }),
    mode !== "upsell" && /* @__PURE__ */ jsx(
      Button,
      {
        icon: AddIcon,
...
function TasksListItem(props) {
  ...
  return /* @__PURE__ */ jsxs(Stack, { space: 3, children: [
    /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 1, children: [
      ...
      /* @__PURE__ */ jsx(TasksUserAvatar, { user: assignedTo ? { id: assignedTo } : void 0, withTooltip: !0 })
    ] }),
...
const TasksUpsellContext = createContext(null), FEATURE = "tasks", TEMPLATE_OPTIONS = { interpolate: /{{([\s\S]+?)}}/g }, BASE_URL = "www.sanity.io";
function TasksUpsellProvider(props) {
  ...
  return /* @__PURE__ */ jsxs(TasksUpsellContext.Provider, { value: ctxValue, children: [
    props.children,
    upsellData && upsellDialogOpen && /* @__PURE__ */ jsx(
      CommentsUpsellDialog,
      {
...
function useTasksUpsell() {
  return useContext(TasksUpsellContext) || {
    upsellData: null,
    handleOpenDialog: () => null,
    upsellDialogOpen: !1,
    telemetryLogs: {
...
const FEEDBACK_FORM_LINK = "https://snty.link/tasks-feedback", Span = styled.span`
  margin-right: 0.2em;
`, Link = styled.a`
  white-space: nowrap;
  > [data-sanity-icon] {
...
function LinkComponent(props) {
  return /* @__PURE__ */ jsxs(Link, { href: FEEDBACK_FORM_LINK, target: "_blank", rel: "noreferrer", children: [
...
function TasksListFeedbackFooter() {
  ...
  return /* @__PURE__ */ jsx(Box, { padding: 4, children: /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "list.feedback.text", t, components: { Link: LinkComponent } }) }) });
}
const LIST_STYLES = {
  marginLeft: "-0.5em",
...
function TasksSidebarHeader(props) {
  const { items: allItems } = props, { mode } = useTasksEnabled(), { state: state2, setViewMode, handleCloseTasks } = useTasksNavigation(), { viewMode, activeTabId } = state2, handleTaskCreate = useCallback(() => {
    setViewMode({ type: "create" });
...
function TasksStudioSidebarInner() {
  const { mode } = useTasksEnabled(), { activeDocument, data, isLoading } = useTasks(), { state: state2, setActiveTab, setViewMode } = useTasksNavigation(), { activeTabId, viewMode, selectedTask } = state2, currentUser = useCurrentUser(), onTaskSelect = useCallback((id) => setViewMode({ type: "edit", id }), [setViewMode]), filteredList = useMemo(() => data.filter((item) => {
    var _a, _b;
  ...
  }), [activeDocument == null ? void 0 : activeDocument.documentId, activeTabId, data, currentUser]), content = useMemo(() => viewMode !== "list" ? /* @__PURE__ */ jsx(TasksFormBuilder, {}, selectedTask) : isLoading ? /* @__PURE__ */ jsx(Flex, { align: "center", justify: "center", children: /* @__PURE__ */ jsx(Spinner, {}) }) : /* @__PURE__ */ jsxs(Fragment$1, { children: [
    mode === "upsell" && /* @__PURE__ */ jsx(TasksUpsellPanel, {}),
    /* @__PURE__ */ jsx(TasksList, { items: filteredList, onTaskSelect })
  ...
  return /* @__PURE__ */ jsxs(RootCard, { display: "flex", height: "fill", flex: 1, overflow: "hidden", children: [
    ...
    viewMode === "list" && /* @__PURE__ */ jsx(TasksListFeedbackFooter, {})
  ] });
}
...
function TaskCreateAction() {
  const { handleOpenTasks, setViewMode } = useTasksNavigation(), { enabled, mode } = useTasksEnabled(), { handleOpenDialog } = useTasksUpsell(), handleCreateTaskFromDocument = useCallback(() => {
    mode === "upsell" ? handleOpenDialog("document_action") : (handleOpenTasks(), setViewMode({ type: "create" }));
  }, [handleOpenTasks, setViewMode, mode, handleOpenDialog]), { t } = useTranslation(tasksLocaleNamespace);
  return enabled ? {
    icon: TaskIcon,
...
const TasksStudioLayoutInner = (props) => {
  ...
  return enabled ? /* @__PURE__ */ jsx(AddonDatasetProvider, { children: /* @__PURE__ */ jsx(
    ConditionalWrapper,
    {
      condition: mode === "upsell",
      wrapper: (children) => /* @__PURE__ */ jsx(TasksUpsellProvider, { children }),
      children: /* @__PURE__ */ jsx(TasksProvider, { children: /* @__PURE__ */ jsx(TasksNavigationProvider, { children: props.renderDefault(props) }) })
    }
  ) }) : props.renderDefault(props);
};
...
function TasksStudioNavbarInner(props) {
  const {
    ...
    handleCloseTasks,
    state: { isOpen }
  } = useTasksNavigation(), { t } = useTranslation(tasksLocaleNamespace), handleClick = useCallback(() => {
    isOpen ? handleCloseTasks() : handleOpenTasks();
  }, [isOpen, handleOpenTasks, handleCloseTasks]), actions = useMemo(() => [
