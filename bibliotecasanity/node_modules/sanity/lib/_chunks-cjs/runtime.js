"use strict";
var viteReact = require("@vitejs/plugin-react"), debug$4 = require("debug"), path = require("path"), readPkgUp = require("read-pkg-up"), vite = require("vite"), cli = require("../cli.js"), history = require("connect-history-api-fallback"), fs = require("fs"), fs$1 = require("fs/promises"), chokidar = require("chokidar"), chalk = require("chalk"), importFresh = require("import-fresh"), React = require("react"), server = require("react-dom/server"), worker_threads = require("worker_threads");
