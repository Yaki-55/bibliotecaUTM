"use strict";
var sanity = require("sanity"), jsxRuntime = require("react/jsx-runtime"), React = require("react"), getJsonStream = require("./getJsonStream.js"), ui = require("@sanity/ui"), orderBy = require("lodash/orderBy.js"), uuid = require("@sanity/uuid"), router$1 = require("sanity/router"), isEqual = require("lodash/isEqual.js"), icons = require("@sanity/icons"), styledComponents = require("styled-components"), react = require("@portabletext/react"), color = require("@sanity/color"), types = require("@sanity/types"), reactI18next = require("react-i18next"), portableTextEditor = require("@sanity/portable-text-editor"), schema$1 = require("@sanity/schema"), theme = require("@sanity/ui/theme"), deburr = require("lodash/deburr.js"), diffMatchPatch = require("@sanity/diff-match-patch"), scrollIntoView = require("scroll-into-view-if-needed"), reactRx = require("react-rx"), rxjs = require("rxjs"), throttle = require("lodash/throttle.js"), PathUtils = require("@sanity/util/paths"), findIndex = require("lodash/findIndex.js"), generateHelpUrl_esm = require("./generate-help-url.esm.js"), uniq = require("lodash/uniq.js"), camelCase = require("lodash/camelCase.js"), speakingurl = require("speakingurl"), kebabCase = require("lodash/kebabCase.js"), framerMotion = require("framer-motion"), telemetry = require("@sanity/telemetry"), react$1 = require("@sanity/telemetry/react"), mendoza = require("mendoza"), legacyDateFormat = require("@sanity/util/legacyDateFormat"), FocusLock = require("react-focus-lock"), assetUtils = require("@sanity/asset-utils"), imageUrlBuilder = require("@sanity/image-url"), deepEquals = require("react-fast-compare"), dateFns = require("date-fns"), debounce = require("lodash/debounce.js"), template = require("lodash/template.js"), omit = require("lodash/omit.js"), uniqueId = require("lodash/uniqueId.js"), reactIs = require("react-is"), find = require("lodash/find.js"), startCase = require("lodash/startCase.js"), operators = require("rxjs/operators"), isHotkeyEsm = require("is-hotkey-esm"), JSONInspector = require("@rexxars/react-json-inspector"), HLRU = require("hashlru"), _internal = require("@sanity/schema/_internal"), shallowEquals = require("shallow-equals"), CopyToClipboard = require("react-copy-to-clipboard"), isNumber = require("lodash/isNumber.js"), isString = require("lodash/isString.js"), uniqBy = require("lodash/uniqBy.js"), negate = require("lodash/negate.js"), _internalBrowser = require("sanity/_internalBrowser"), rxjsExhaustmapWithTrailing = require("rxjs-exhaustmap-with-trailing");
...
var React__namespace = /* @__PURE__ */ _interopNamespaceCompat(React), orderBy__default = /* @__PURE__ */ _interopDefaultCompat(orderBy), isEqual__default = /* @__PURE__ */ _interopDefaultCompat(isEqual), deburr__default = /* @__PURE__ */ _interopDefaultCompat(deburr), scrollIntoView__default = /* @__PURE__ */ _interopDefaultCompat(scrollIntoView), throttle__default = /* @__PURE__ */ _interopDefaultCompat(throttle), PathUtils__namespace = /* @__PURE__ */ _interopNamespaceCompat(PathUtils), findIndex__default = /* @__PURE__ */ _interopDefaultCompat(findIndex), uniq__default = /* @__PURE__ */ _interopDefaultCompat(uniq), camelCase__default = /* @__PURE__ */ _interopDefaultCompat(camelCase), speakingurl__default = /* @__PURE__ */ _interopDefaultCompat(speakingurl), kebabCase__default = /* @__PURE__ */ _interopDefaultCompat(kebabCase), FocusLock__default = /* @__PURE__ */ _interopDefaultCompat(FocusLock), imageUrlBuilder__default = /* @__PURE__ */ _interopDefaultCompat(imageUrlBuilder), deepEquals__default = /* @__PURE__ */ _interopDefaultCompat(deepEquals), debounce__default = /* @__PURE__ */ _interopDefaultCompat(debounce), template__default = /* @__PURE__ */ _interopDefaultCompat(template), omit__default = /* @__PURE__ */ _interopDefaultCompat(omit), uniqueId__default = /* @__PURE__ */ _interopDefaultCompat(uniqueId), find__default = /* @__PURE__ */ _interopDefaultCompat(find), startCase__default = /* @__PURE__ */ _interopDefaultCompat(startCase), JSONInspector__default = /* @__PURE__ */ _interopDefaultCompat(JSONInspector), HLRU__default = /* @__PURE__ */ _interopDefaultCompat(HLRU), shallowEquals__default = /* @__PURE__ */ _interopDefaultCompat(shallowEquals), CopyToClipboard__default = /* @__PURE__ */ _interopDefaultCompat(CopyToClipboard), isNumber__default = /* @__PURE__ */ _interopDefaultCompat(isNumber), isString__default = /* @__PURE__ */ _interopDefaultCompat(isString), uniqBy__default = /* @__PURE__ */ _interopDefaultCompat(uniqBy), negate__default = /* @__PURE__ */ _interopDefaultCompat(negate);
...
}), CommentsUpsellContext = React.createContext(null), FEATURE$1 = "comments", TEMPLATE_OPTIONS$1 = { interpolate: /{{([\s\S]+?)}}/g }, BASE_URL$1 = "www.sanity.io";
...
function usePaneLayout() {
  const pane2 = React.useContext(PaneLayoutContext);
  if (!pane2)
...
const PANE_DEBUG = !1, PANE_COLLAPSED_WIDTH = 51, PANE_DEFAULT_MIN_WIDTH = 204, PaneContext = React.createContext(null), Root$g = styledComponents.styled(ui.Layer)`
  position: relative;
  width: 1px;
  min-width: 1px;
...
const Root$f = styledComponents.styled(ui.Card)`
  outline: none;
...
}), Root$e = styledComponents.styled(ui.Card)`
  position: relative;
  outline: none;
`;
Root$e.displayName = "PaneContent__root";
function usePane() {
  const pane2 = React.useContext(PaneContext);
  if (!pane2)
...
const Root$d = styledComponents.styled(ui.Layer)`
  position: sticky;
  bottom: 0;
...
`, RootCard$2 = styledComponents.styled(ui.Card)`
...
}), Root$c = styledComponents.styled(ui.Layer)(({ $border }) => styledComponents.css`
    line-height: 0;
    position: sticky;
    top: 0;
...
`, TitleCard = styledComponents.styled(ui.Card)(({ theme: theme2 }) => {
...
`, TitleText = styledComponents.styled(ui.Text)`
  cursor: default;
  outline: none;
`, TabsBox = styledComponents.styled(ui.Box)(({ theme: theme2 }) => {
...
const StyledAvatar = styledComponents.styled(ui.Avatar)`
  svg > ellipse {
    stroke: transparent;
  }
...
const SpacerAvatar = styledComponents.styled.div((props) => {
  var _a;
...
}), editorSchemaType = schema.get("body"), Span$2 = styledComponents.styled.span(({ theme: theme2 }) => {
  var _a, _b, _c;
...
function MentionInlineBlock(props) {
  ...
  return !user || loading ? /* @__PURE__ */ jsxRuntime.jsx(
    ...
    getJsonStream.Tooltip,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(Span$2, { "data-selected": selected, "data-active": (currentUser == null ? void 0 : currentUser.id) === userId, children: [
        "@",
        user.displayName
      ] })
    }
...
const EMPTY_ARRAY$f = [], Root$a = styledComponents.styled(ui.Stack)({
  maxWidth: "220px"
  // todo: improve
...
const POPOVER_FALLBACK_PLACEMENTS$4 = ["bottom", "top"], INLINE_STYLE = { outline: "none" }, EMPTY_ARRAY$e = [], PlaceholderWrapper = styledComponents.styled.span((props) => {
  ...
  return styledComponents.css`
    ...
    display: block;
  `;
}), StyledPopover$1 = styledComponents.styled(getJsonStream.Popover)(({ theme: theme2 }) => {
...
const RootCard$1 = styledComponents.styled(ui.Card)(({ theme: theme$1 }) => {
  ...
  `;
}), AvatarContainer = styledComponents.styled.div((props) => {
  var _a;
  return `
...
const TEXT_SIZE = 1, ContentStack$1 = styledComponents.styled(ui.Stack)`
  max-width: 180px;
...
const stopPropagation = (e) => e.stopPropagation(), ContextMenuBox = styledComponents.styled(ui.Box)``, SKELETON_INLINE_STYLE = { width: "50%" }, EMPTY_ARRAY$b = [], TimeText = styledComponents.styled(ui.Text)(({ theme: theme2 }) => {
  ...
  `;
}), HeaderFlex$1 = styledComponents.styled(ui.Flex)((props) => {
  var _a;
...
`, ErrorFlex = styledComponents.styled(ui.Flex)((props) => {
  var _a;
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
    min-height: ${(_a = theme$1.avatar.sizes[props.$size]) == null ? void 0 : _a.size}px;
...
`, RootStack$1 = styledComponents.styled(ui.Stack)(({ theme: theme2 }) => {
...
const ThreadCard = styledComponents.styled(ui.Card).attrs({ padding: 3, radius: 3, sizing: "border" })(
  ...
  `), ExpandButton = styledComponents.styled(getJsonStream.Button)(({ theme: theme2 }) => {
...
}), CommentsList = React.memo(CommentsListInner), Root$9 = styledComponents.styled(ui.Box)`
  max-width: 280px;
...
`, StyledPopover = styledComponents.styled(getJsonStream.Popover)`
  opacity: 0;
...
const StyledButton$1 = styledComponents.styled(getJsonStream.Button)(({ theme: theme$1 }) => {
...
const ContentStack = styledComponents.styled(ui.Stack)`
  width: 320px;
`;
...
const MotionPopover$1 = styledComponents.styled(framerMotion.motion(getJsonStream.Popover))`
  user-select: none;
...
const POPOVER_FALLBACK_PLACEMENTS$1 = ["bottom", "top"], MotionPopover = framerMotion.motion(getJsonStream.Popover), RootStack = styledComponents.styled(ui.Stack)`
  width: 250px;
`, VARIANTS$3 = {
  hidden: { opacity: 0 },
  visible: { opacity: 1 }
...
const FEEDBACK_FORM_LINK$1 = "https://snty.link/comments-beta-feedback", Span$1 = styledComponents.styled.span`
  margin-right: 0.2em;
...
function CommentsInspectorFeedbackFooter() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(FooterCard, { padding: 4, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { muted: !0, size: 1, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(Link$1, { href: FEEDBACK_FORM_LINK$1, target: "_blank", rel: "noreferrer", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(Span$1, { children: [
...
}), RootLayer = styledComponents.styled(ui.Layer)`
  display: flex;
  flex-direction: column;
  height: 100%;
  overflow: hidden;
...
const Root$6 = styledComponents.styled.div`
  position: absolute;
  top: 0;
  left: -4px;
  bottom: 0;
...
const Root$5 = styledComponents.styled(ui.Box)`
  position: relative;
  flex: 1;
  padding-left: 1px;
`;
...
const JSONInspectorWrapper = styledComponents.styled.div(({ theme: theme2 }) => {
...
const TitleContainer = styledComponents.styled(ui.Stack)`
  ${({ theme: theme2 }) => styledComponents.css`
...
`, ListWrapper = styledComponents.styled(ui.Flex)`
  ...
  min-width: 244px;
`, Root$4 = styledComponents.styled(ui.Box)(({ $visible }) => styledComponents.css`
    opacity: 0;
    pointer-events: none;
...
}, IconWrapper = styledComponents.styled(ui.Flex)(({ theme: theme2 }) => {
  var _a;
  ...
  `;
}), Root$3 = styledComponents.styled(ui.Button)(({ $selected, $disabled }) => styledComponents.css`
    position: relative;
    width: 100%;
...
const Root$2 = styledComponents.styled(getJsonStream.Popover)`
  overflow: hidden;
  overflow: clip;
`;
...
const DocumentPaneProvider = React.memo((props) => {
  const { children, index, pane: pane2, paneKey, onFocusPath } = props, schema2 = sanity.useSchema(), templates = sanity.useTemplates(), {
    __internal_tasks,
    document: {
    ...
    title = null,
    views: viewsProp = []
  } = pane2, paneOptions = sanity.useUnique(options), documentIdRaw = paneOptions.id, documentId = sanity.getPublishedId(documentIdRaw), documentType = options.type, params = sanity.useUnique(paneRouter.params) || EMPTY_PARAMS$2, panePayload = sanity.useUnique(paneRouter.payload), { templateName, templateParams } = React.useMemo(
...
const EMPTY_ARRAY$5 = [], rotate = styledComponents.keyframes`
  from {
...
const addSelectedStateToMenuItems = (options) => {
  ...
  const { childItemId, index, isActive, isSelected, pane: pane2, paneKey } = props, schema2 = sanity.useSchema(), { name: parentSourceName } = sanity.useSource(), {
    ...
    menuItems,
    options
  } = pane2, { apiVersion, defaultOrdering = EMPTY_ARRAY$5, filter } = options, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane2.source, typeName = React.useMemo(() => getTypeNameFromSingleTypeFilter(filter, params), [filter, params]), showIcons = (displayOptions == null ? void 0 : displayOptions.showIcons) !== !1, [layout, setLayout] = useStructureToolSetting(
    "layout",
    typeName,
    defaultLayout
...
var views = /* @__PURE__ */ Object.freeze({
  ...
  form,
  maybeSerializeView
}), __defProp$7 = Object.defineProperty, __defNormalProp$7 = (obj, key, value) => key in obj ? __defProp$7(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __publicField$7 = (obj, key, value) => (__defNormalProp$7(obj, typeof key != "symbol" ? key + "" : key, value), value);
  ...
  function(props) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { muted: !0, size: 1, children: [
        ...
        " \u2022",
        " ",
        /* @__PURE__ */ jsxRuntime.jsx(getJsonStream.Tooltip, { content: formattedDate, placement: "top-end", children: /* @__PURE__ */ jsxRuntime.jsx(NoWrap, { children: /* @__PURE__ */ jsxRuntime.jsx("time", { dateTime: formattedDate, children: timeAgo }) }) })
      ] })
    ] });
  },
  (prevProps, nextProps) => prevProps.activity.timestamp === nextProps.activity.timestamp
), TasksEnabledContext = React.createContext(null);
function TasksEnabledProvider({ children }) {
  var _a;
  const { enabled, isLoading } = sanity.useFeatureEnabled("sanityTasks"), isWorkspaceEnabled = (_a = sanity.useWorkspace().tasks) == null ? void 0 : _a.enabled, value = React.useMemo(() => !isWorkspaceEnabled || isLoading ? {
    enabled: !1,
    mode: null
  } : {
    enabled: !0,
...
const TasksNavigationContext = React.createContext(null), TaskCreated = telemetry.defineEvent({
  name: "Task Created",
  version: 1,
...
const TasksNavigationProvider = ({ children }) => {
  const [state2, dispatch] = React.useReducer(reducer, initialState), router2 = router$1.useRouter(), toast = ui.useToast(), telemetry2 = react$1.useTelemetry(), setViewMode = React.useCallback((viewMode) => {
  ...
  }, [state2.selectedTask, state2.viewMode, telemetry2, toast]), searchParamsAsString = new URLSearchParams(router2.state._searchParams).toString();
  return React.useEffect(() => {
...
function TasksProvider(props) {
  const { children } = props, [activeDocument, setActiveDocument] = React.useState(null), { data = EMPTY_ARRAY$4, isLoading } = useTasksStore({}), debouncedSetActiveDocument = React.useCallback(debounce__default.default(setActiveDocument, 1e3), []), value = React.useMemo(
    () => ({
      activeDocument,
...
const AvatarRoot = styledComponents.styled.div(
  (props) => {
    var _a, _b;
    const theme$1 = theme.getTheme_v2(props.theme);
    return styledComponents.css`
...
), AvatarSkeleton = styledComponents.styled(ui.Skeleton)((props) => {
  var _a, _b;
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
...
function TasksActivityCommentInput(props) {
  const { mentionOptions, currentUser, onSubmit } = props, { mode } = useTasksEnabled(), [value, setValue] = React.useState(null), editorRef = React.useRef(null), hasValue = React.useMemo(() => hasCommentMessageValue(value), [value]), handleChange = React.useCallback((nextValue) => {
    setValue(nextValue);
  }, []), handleSubmit = React.useCallback(() => {
...
const COMMENTS_LIST_ITEM_AVATAR_CONFIG = {
  ...
  replyAvatar: !0,
  avatarSize: 0
}, CommentListItemRoot = styledComponents.styled.div((props) => {
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
    [data-ui='comments-list-item'] {
...
`, TasksActivityCreatedAt = React.memo(
  function(props) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ActivityItem, { userId: authorId, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", paddingTop: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: 1, muted: !0, children: [
      ...
      " \u2022",
      " ",
      /* @__PURE__ */ jsxRuntime.jsx(getJsonStream.Tooltip, { content: formattedDate, placement: "top-end", children: /* @__PURE__ */ jsxRuntime.jsx(NoWrap, { children: /* @__PURE__ */ jsxRuntime.jsx("time", { dateTime: createdAt, children: timeAgo }) }) })
    ] }) }) });
  },
...
function TasksSubscriberAvatars(props) {
  const { subscriberIds: subscriberIdsProp } = props, subscriberIds = React.useMemo(() => (subscriberIdsProp == null ? void 0 : subscriberIdsProp.filter(Boolean)) || EMPTY_ARRAY$3, [subscriberIdsProp]);
...
const EMPTY_ARRAY$2 = [], VARIANTS$2 = {
...
const FocusableCard = styledComponents.styled(ui.Card)((props) => {
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
    &[data-as='button'] {
...
const StyledButton = styledComponents.styled(ui.Button)`
  padding: 3px 6px;
`;
function AssigneeEditFormField(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    AssigneeSelectionMenu,
    {
      onSelect,
      value,
      menuButton: /* @__PURE__ */ jsxRuntime.jsx(StyledButton, { mode: "ghost", padding: 0, children: /* @__PURE__ */ jsxRuntime.jsx(
        getJsonStream.Tooltip,
        {
...
}, DescriptionInputRoot = styledComponents.styled.div((props) => {
  const theme$1 = theme.getTheme_v2(props.theme), verticalPadding = props.$mode === "edit" ? theme$1.space[1] : theme$1.space[3], minHeight = props.$mode === "edit" ? 120 : 200;
  return styledComponents.css`
...
const FieldWrapperRoot = styledComponents.styled.div((props) => {
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
...
const StatusMenuButton = React.forwardRef(function(props, ref) {
  var _a;
  const { t } = sanity.useTranslation(tasksLocaleNamespace), { value, options, ...rest } = props, selectedOption = options.find((option) => option.value === value), icon = (_a = TASK_STATUS.find((status) => status.value === value)) == null ? void 0 : _a.icon;
  return /* @__PURE__ */ jsxRuntime.jsx(
    getJsonStream.Button,
    {
      ...rest,
...
function StatusSelector(props) {
  const { value, onChange, options, path } = props, telemetry2 = react$1.useTelemetry(), handleStatusChange = React.useCallback(
    (next) => {
      onChange(sanity.set(next, path)), telemetry2.log(TaskStatusChanged, { from: value, to: next });
    },
...
const EmptyReferenceRoot = styledComponents.styled(ui.Card)((props) => {
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
    &:focus {
      border: 1px solid var(--card-focus-ring-color);
  ...
  `;
}), Placeholder = styledComponents.styled(ui.Text)((props) => `
...
`, StyledIntentLink$1 = styledComponents.styled(router$1.IntentLink)(() => styledComponents.css`
...
const Root$1 = styledComponents.styled.div((props) => `
      display: grid;
      grid-template-columns: 1fr;
      padding-top: ${theme.getTheme_v2(props.theme).space[3]}px;
    `), TitleInput = styledComponents.styled.textarea((props) => {
...
function FormCreate(props) {
  const { onChange } = props, {
    ...
    setActiveTab,
    state: { viewMode }
  } = useTasksNavigation(), toast = ui.useToast(), telemetry2 = react$1.useTelemetry(), [createMore, setCreateMore] = React.useState(!1), handleCreateMore = React.useCallback(() => setCreateMore((p) => !p), []), value = props.value, onRemove = React.useCallback(() => {
    ...
    ]), createMore ? setViewMode({ type: "create" }) : setActiveTab("subscribed"), telemetry2.log(TaskCreated), toast.push({
      closable: !0,
      status: "success",
      title: t("form.status.success")
    });
  }, [value, onChange, createMore, telemetry2, toast, t, setViewMode, setActiveTab]);
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    props.renderDefault(props),
...
function RemoveTaskDialog(props) {
  ...
  return showDialog ? /* @__PURE__ */ jsxRuntime.jsx(
    getJsonStream.Dialog,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(ui.Stack, { space: 3, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { as: "p", children: t("dialog.remove-task.body") }) })
    }
  ) : null;
}
const FirstRow = styledComponents.styled(ui.Flex)((props) => {
  const theme$1 = theme.getTheme_v2(props.theme);
  return styledComponents.css`
...
function FormActionsMenu({ id, value }) {
  const { setViewMode, handleCopyLinkToTask } = useTasksNavigation(), { mode } = useTasksEnabled(), telemetry2 = react$1.useTelemetry(), onTaskRemoved = React.useCallback(() => {
    setViewMode({ type: "list" }), telemetry2.log(TaskRemoved);
  }, [setViewMode, telemetry2]), removeTask = useRemoveTask({ id, onRemoved: onTaskRemoved }), duplicateTask = React.useCallback(() => {
    setViewMode({ type: "duplicate", duplicateTaskValues: value }), telemetry2.log(TaskDuplicated);
  }, [setViewMode, telemetry2, value]), { t } = sanity.useTranslation(tasksLocaleNamespace);
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
  ...
  return (_a = props.value) != null && _a._id ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { borderTop: !0, marginTop: 3, children: /* @__PURE__ */ jsxRuntime.jsx(
      FirstRow,
      {
        ...
        justify: "flex-start",
        wrap: "wrap",
        children: /* @__PURE__ */ jsxRuntime.jsxs(getJsonStream.TooltipDelayGroupProvider, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            StatusSelector,
            {
...
function TasksNotificationTargetInner(props) {
  var _a, _b, _c;
  const { inputProps } = props, { onChange } = inputProps, { target, _id, context, _rev } = sanity.useFormValue([]), { title: workspaceTitle, basePath } = sanity.useWorkspace(), client = sanity.useClient(sanity.DEFAULT_STUDIO_CLIENT_OPTIONS), imageBuilder = React.useMemo(() => imageUrlBuilder__default.default(client), [client]), documentId = (_b = (_a = target == null ? void 0 : target.document) == null ? void 0 : _a._ref) != null ? _b : "", documentType = (_c = target == null ? void 0 : target.documentType) != null ? _c : "", { isLoading: previewValuesLoading, value } = useDocumentPreviewValues({
    documentId,
    documentType
    ...
    const contextUrl = (_a2 = context == null ? void 0 : context.notification) != null && _a2.url ? new URL((_b2 = context == null ? void 0 : context.notification) == null ? void 0 : _b2.url) : "", currentUrl = new URL(`${window.location.origin}${basePath}/`), studioUrl = (
      ...
      contextUrl && sanity.isDev ? contextUrl : currentUrl
    );
  ...
  return React.useEffect(() => {
    documentId && documentType && previewValuesLoading || _rev && (deepEquals__default.default(context == null ? void 0 : context.notification, notificationTarget) || onChange(sanity.set(notificationTarget, ["notification"])));
...
}, FormBuilderRoot = styledComponents.styled(framerMotion.motion.div)((props) => {
  const theme$1 = theme.getTheme_v2(props.theme);
  return `
...
function EmptyStatusListState({ status }) {
  const {
    state: { activeTabId }
  } = useTasksNavigation(), { t } = sanity.useTranslation(tasksLocaleNamespace), { heading, text } = HEADING_BY_STATUS[status][activeTabId];
...
function EmptyTasksListState() {
  const { activeDocument } = useTasks(), { mode } = useTasksEnabled(), {
    state: { activeTabId },
    setViewMode
  } = useTasksNavigation(), key = !activeDocument && activeTabId === "document" ? "noActiveDocument" : activeTabId, { heading, text } = EMPTY_TASK_LIST[key], { t } = sanity.useTranslation(tasksLocaleNamespace), handleTaskCreate = React.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 3, align: "center", flex: 1, justify: "center", children: [
    /* @__PURE__ */ jsxRuntime.jsx(AnimatedText, { size: 1, weight: "semibold", children: t(heading) }, key),
    /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { paddingBottom: 6, paddingTop: 1, children: /* @__PURE__ */ jsxRuntime.jsx(AnimatedText, { size: 1, align: "center", children: t(text) }, key) }),
    mode !== "upsell" && /* @__PURE__ */ jsxRuntime.jsx(
      getJsonStream.Button,
      {
        icon: icons.AddIcon,
...
const StyledIntentLink = styledComponents.styled(router$1.IntentLink)((props) => `
  text-decoration: underline;
...
const TasksUpsellContext = React.createContext(null), FEATURE = "tasks", TEMPLATE_OPTIONS = { interpolate: /{{([\s\S]+?)}}/g }, BASE_URL = "www.sanity.io";
function TasksUpsellProvider(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(TasksUpsellContext.Provider, { value: ctxValue, children: [
    props.children,
    upsellData && upsellDialogOpen && /* @__PURE__ */ jsxRuntime.jsx(
      CommentsUpsellDialog,
      {
...
function useTasksUpsell() {
  return React.useContext(TasksUpsellContext) || {
    upsellData: null,
    handleOpenDialog: () => null,
    upsellDialogOpen: !1,
    telemetryLogs: {
...
function TasksUpsellPanel() {
  ...
  return data ? /* @__PURE__ */ jsxRuntime.jsx(
    CommentsUpsellPanel,
    {
      data,
      onPrimaryClick,
...
const FEEDBACK_FORM_LINK = "https://snty.link/tasks-feedback", Span = styledComponents.styled.span`
  margin-right: 0.2em;
...
function TasksListFeedbackFooter() {
  const { t } = sanity.useTranslation(tasksLocaleNamespace);
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 4, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { muted: !0, size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { i18nKey: "list.feedback.text", t, components: { Link: LinkComponent } }) }) });
}
const LIST_STYLES = {
  marginLeft: "-0.5em",
...
const Divider = styledComponents.styled.div((props) => `
    height: 25px;
    width: 1px;
...
const MENU_BUTTON_POPOVER_PROPS = {
  ...
  placement: "bottom-end",
  portal: !0
}, StyledMenu = styledComponents.styled(ui.Menu)`
  width: 220px;
`;
...
function TasksSidebarHeader(props) {
  const { items: allItems } = props, { mode } = useTasksEnabled(), { state: state2, setViewMode, handleCloseTasks } = useTasksNavigation(), { viewMode, activeTabId } = state2, handleTaskCreate = React.useCallback(() => {
    setViewMode({ type: "create" });
...
const RootCard = styledComponents.styled(ui.Card)`
  flex: 1;
  flex-direction: column;
`, HeaderStack = styledComponents.styled(ui.Stack)`
  border-bottom: 1px solid var(--card-border-color);
`, ContentFlex = styledComponents.styled(ui.Flex)`
  overflow-y: scroll;
  overflow-x: hidden;
`;
function TasksStudioSidebarInner() {
  const { mode } = useTasksEnabled(), { activeDocument, data, isLoading } = useTasks(), { state: state2, setActiveTab, setViewMode } = useTasksNavigation(), { activeTabId, viewMode, selectedTask } = state2, currentUser = sanity.useCurrentUser(), onTaskSelect = React.useCallback((id) => setViewMode({ type: "edit", id }), [setViewMode]), filteredList = React.useMemo(() => data.filter((item) => {
    var _a, _b;
...
function TaskCreateAction() {
  ...
  }, [handleOpenTasks, setViewMode, mode, handleOpenDialog]), { t } = sanity.useTranslation(tasksLocaleNamespace);
  return enabled ? {
    icon: icons.TaskIcon,
...
const VARIANTS = {
  hidden: { opacity: 0 },
  visible: { opacity: 1 }
}, TRANSITION = { duration: 0.2 }, FULLSCREEN_MEDIA_INDEX = 1, POSITION_ABSOLUTE_MEDIA_INDEX = 2, RootFlex = styledComponents.styled(ui.Flex)(({ theme: theme2 }) => {
...
const TasksStudioLayoutInner = (props) => {
  ...
  return enabled ? /* @__PURE__ */ jsxRuntime.jsx(sanity.AddonDatasetProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(
    getJsonStream.ConditionalWrapper,
    {
      condition: mode === "upsell",
      wrapper: (children) => /* @__PURE__ */ jsxRuntime.jsx(TasksUpsellProvider, { children }),
      children: /* @__PURE__ */ jsxRuntime.jsx(TasksProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(TasksNavigationProvider, { children: props.renderDefault(props) }) })
    }
  ) }) : props.renderDefault(props);
};
...
function TasksStudioNavbarInner(props) {
  const {
    ...
    handleCloseTasks,
    state: { isOpen }
  } = useTasksNavigation(), { t } = sanity.useTranslation(tasksLocaleNamespace), handleClick = React.useCallback(() => {
