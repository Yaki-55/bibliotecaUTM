"use strict";
var generateHelpUrl_esm = require("./generate-help-url.esm.js"), fs = require("fs"), path = require("path"), resolveFrom = require("resolve-from"), semver = require("semver"), execa = require("execa"), fs$1 = require("fs/promises"), oneline = require("oneline"), perf_hooks = require("perf_hooks");
