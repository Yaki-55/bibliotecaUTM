...
var json5__namespace = /* @__PURE__ */ _interopNamespaceCompat(json5), z__namespace = /* @__PURE__ */ _interopNamespaceCompat(z), fs__default$1 = /* @__PURE__ */ _interopDefaultCompat(fs$1), createDebug__default = /* @__PURE__ */ _interopDefaultCompat(createDebug), glob__default = /* @__PURE__ */ _interopDefaultCompat(glob), fs__default = /* @__PURE__ */ _interopDefaultCompat(fs), path__default = /* @__PURE__ */ _interopDefaultCompat(path), t__namespace = /* @__PURE__ */ _interopNamespaceCompat(t), traverse__default = /* @__PURE__ */ _interopDefaultCompat(traverse), register__default = /* @__PURE__ */ _interopDefaultCompat(register);
const configDefintion = z__namespace.object({
  path: z__namespace.string().or(z__namespace.array(z__namespace.string())).default("./src/**/*.{ts,tsx,js,jsx,mjs,cjs}"),
...
async function readConfig(path2) {
  try {
    const content = await promises.readFile(path2, "utf-8"), json = json5__namespace.parse(content);
...
function getBabelConfig(path2) {
  return { extends: findBabelConfig(path2 || __dirname) };
}
...
const require$1 = node_module.createRequire(__filename), groqTagName = "groq";
...
`);
  ...
  generateTypeNodeTypes(identifierName, typeNode) {
    ...
    return new generator.CodeGenerator(t__namespace.exportNamedDeclaration(typeAlias)).generate().code;
  }
  static generateKnownTypes() {
    ...
    return decleration.declare = !0, new generator.CodeGenerator(t__namespace.exportNamedDeclaration(decleration)).generate().code;
  }
  /**
