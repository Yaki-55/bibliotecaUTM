...
const require$1 = createRequire(__filename), groqTagName = "groq";
...
`);
  ...
  static generateKnownTypes() {
    ...
    return decleration.declare = !0, new CodeGenerator(t.exportNamedDeclaration(decleration)).generate().code;
  }
  /**
