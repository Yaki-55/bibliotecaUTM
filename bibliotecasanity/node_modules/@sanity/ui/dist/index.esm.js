  ...
  return /* @__PURE__ */ jsxs(
    Root$t,
    {
      ...
      children: [
        ...
        (icon || text || iconRight) && /* @__PURE__ */ jsx(Box, { as: "span", ...boxProps, children: /* @__PURE__ */ jsxs(Flex, { as: "span", justify, gap: space, children: [
          icon && /* @__PURE__ */ jsxs(Text, { size: fontSize2, children: [
          ...
          iconRight && /* @__PURE__ */ jsxs(Text, { size: fontSize2, children: [
  ...
  const handleClearMouseDown = useCallback((event) => {
    ...
    () => /* @__PURE__ */ jsxs(
      Presentation,
      {
        ...
        "data-tone": rootTheme.tone,
        children: [
          icon && /* @__PURE__ */ jsx(LeftBox, { padding, children: /* @__PURE__ */ jsxs(Text, { size: fontSize2, children: [
            isValidElement(icon) && icon,
            isValidElementType(icon) && createElement(icon)
          ] }) }),
          !$hasClearButton && iconRight && /* @__PURE__ */ jsx(RightBox, { padding, children: /* @__PURE__ */ jsxs(Text, { size: fontSize2, children: [
            isValidElement(iconRight) && iconRight,
            isValidElementType(iconRight) && createElement(iconRight)
          ] }) })
        ]
...
`, Menu = forwardRef(function(props, ref) {
  ...
  ), menu = isElement$1(menuProp) ? cloneElement(menuProp, menuProps) : null, setButtonRef = useCallback(
    (el) => {
      typeof ref == "function" ? ref(el) : ref && (ref.current = el), setButtonElement(el);
    },
    [ref]
  ), button = useMemo(
    () => isElement$1(buttonProp) ? cloneElement(buttonProp, {
      "data-ui": "MenuButton",
      id,
...
const MenuItem = forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ jsxs(
    Selectable,
    {
      ...
      type: as === "button" ? "button" : void 0,
      children: [
        (icon || text || iconRight) && /* @__PURE__ */ jsxs(Flex, { as: "span", gap: space, align: "center", ...paddingProps, children: [
          icon && /* @__PURE__ */ jsxs(Text, { size: fontSize2, children: [
            isValidElement(icon) && icon,
            isValidElementType(icon) && createElement(icon)
          ] }),
  ...
  const content = /* @__PURE__ */ jsxs(Flex, { padding, children: [
    /* @__PURE__ */ jsxs(
      Box,
      {
        ...
        children: [
          icon && /* @__PURE__ */ jsx(Text, { muted, size: fontSize2, weight, children: createElement(icon) }),
          !icon && /* @__PURE__ */ jsx(ToggleArrowText, { muted, size: fontSize2, weight, children: /* @__PURE__ */ jsx(ToggleArrowRightIcon, { style: { transform: expanded ? "rotate(90deg)" : void 0 } }) })
        ]
      }
    ),
