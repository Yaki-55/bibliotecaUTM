...
class BufferList {
  constructor() {
    __publicField(this, "buffered"), __publicField(this, "shifted"), __publicField(this, "queue"), __publicField(this, "_offset"), this.buffered = 0, this.shifted = 0, this.queue = new FIFO(), this._offset = 0;
  }
  push(buffer) {
