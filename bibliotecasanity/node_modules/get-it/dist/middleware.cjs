...
var http = require("http"), https = require("https"), debugIt = require("debug"), defaultOptionsValidator = require("./_chunks-cjs/defaultOptionsValidator.cjs"), progressStream = require("progress-stream"), allowed = require("is-retry-allowed");
