...
function UnknownPane(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(Pane, { id: paneKey, selected: isSelected, children: [
    (0, import_jsx_runtime.jsx)(PaneHeader, { title: t("panes.unknown-pane-type.title") }),
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-A6COJE4B.js")),
  document: (0, import_react.lazy)(() => import("./pane-D56HTSPC.js").then(function(n) {
    return n.aa;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-D56HTSPC.js").then(function(n) {
    return n.ab;
  })),
  list: (0, import_react.lazy)(() => import("./index2-IZTWAA5K.js"))
};
...
//# sourceMappingURL=index3-SNURIXJU.js.map
