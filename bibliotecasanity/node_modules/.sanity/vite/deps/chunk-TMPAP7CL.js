...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-4TBFTLYK.js")
});
...
function CommentBreadcrumbs(props) {
  const { titlePath, maxLength } = props, items = (0, import_react.useMemo)(() => {
  ...
  }, [maxLength, titlePath]), nodes = (0, import_react.useMemo)(() => items.map((item, index) => {
    const key = `${item}-${index}`, showSeparator = index < items.length - 1;
    return Array.isArray(item) ? (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [
    ...
    ] }, key) : (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [
...
function CommentDeleteDialog(props) {
  const { isParent, onClose, commentId, onConfirm, loading, error } = props, { t } = useTranslation2(commentsLocaleNamespace), dialogCopy = getDialogCopy(t), { title, body, confirmButtonText } = dialogCopy[isParent ? "thread" : "comment"], handleDelete = (0, import_react.useCallback)(() => {
    onConfirm(commentId);
  }, [commentId, onConfirm]);
...
var CommentDisabledIcon = (0, import_react.forwardRef)(function(props, ref) {
...
var CommentIcon2 = (0, import_react.forwardRef)(function(props, ref) {
  return (0, import_jsx_runtime.jsx)(
    "svg",
    {
...
var MentionIcon = (0, import_react.forwardRef)(function(props, ref) {
  return (0, import_jsx_runtime.jsxs)(
    "svg",
    {
...
var ReactionIcon = (0, import_react.forwardRef)(function(props, ref) {
  return (0, import_jsx_runtime.jsxs)(
    "svg",
    {
...
var SendIcon = (0, import_react.forwardRef)(function(props, ref) {
  return (0, import_jsx_runtime.jsx)(
    "svg",
    {
...
var CommentsAuthoringPathContext = (0, import_react.createContext)(
  null
);
function CommentsAuthoringPathProvider(props) {
  const { children } = props, [authoringPath, setAuthoringPath] = (0, import_react.useState)(null), handleSetAuthoringPath = (0, import_react.useCallback)((nextAuthoringPath) => {
...
var CommentRangeDecoration = (0, import_react.memo)(function(props) {
  const {
    children,
    commentId,
    ...
    selectedThreadId,
    threadId
  } = props, decoratorRef = (0, import_react.useRef)(null), isNestedRef = (0, import_react.useRef)(false), parentCommentId = (0, import_react.useRef)(null);
  ...
  const handleMouseEnter = (0, import_react.useCallback)(() => onHoverStart(commentId), [commentId, onHoverStart]), handleMouseLeave = (0, import_react.useCallback)(() => onHoverEnd(null), [onHoverEnd]), handleClick = (0, import_react.useCallback)(() => onClick(commentId), [commentId, onClick]), hovered = currentHoveredCommentId === commentId || currentHoveredCommentId === parentCommentId.current && isNestedRef.current;
  return (0, import_jsx_runtime.jsx)(
...
function useCommentsStore(opts) {
  const { client, documentId, onLatestTransactionIdReceived, transactionsIdMap } = opts, [state2, dispatch] = (0, import_react.useReducer)(commentsReducer, INITIAL_STATE$2), [loading, setLoading] = (0, import_react.useState)(client !== null), [error, setError] = (0, import_react.useState)(null), didInitialFetch = (0, import_react.useRef)(false), params = (0, import_react.useMemo)(() => ({ documentId: getPublishedId(documentId) }), [documentId]), initialFetch = (0, import_react.useCallback)(async () => {
    if (!client) {
      setLoading(false);
      return;
    }
  ...
  }, [client, params]), handleListenerEvent = (0, import_react.useCallback)(
    async (event) => {
      var _a;
  ...
  ), listener$ = (0, import_react.useMemo)(() => client ? client.observable.listen(QUERY$1, params, LISTEN_OPTIONS$1).pipe(
  ...
  return (0, import_react.useEffect)(() => {
    ...
    data: (0, import_react.useMemo)(() => Object.values(state2.comments), [state2.comments]),
    dispatch,
    error,
    loading
  };
...
var CommentsProvider = (0, import_react.memo)(function(props) {
  const { children, documentId, documentType, isCommentsOpen, onCommentsOpen, sortOrder, type } = props, commentsEnabled = useCommentsEnabled(), [status, setStatus] = (0, import_react.useState)("open"), { client, createAddonDataset, isCreatingDataset } = useAddonDataset(), publishedId = getPublishedId(documentId), editState = useEditState(publishedId, documentType, "low"), schemaType = useSchema().get(documentType), currentUser = useCurrentUser(), { name: workspaceName, dataset, projectId } = useWorkspace(), documentValue = (0, import_react.useMemo)(() => editState.draft || editState.published, [editState.draft, editState.published]), documentRevisionId = (0, import_react.useMemo)(() => documentValue == null ? void 0 : documentValue._rev, [documentValue]), transactionsIdMap = (0, import_react.useMemo)(() => /* @__PURE__ */ new Map(), []), handleOnLatestTransactionIdReceived = (0, import_react.useCallback)(
    (commentDocumentId) => {
  ...
  }), handleOnTransactionStart = (0, import_react.useCallback)(
    (commentDocumentId, transactionId) => {
      transactionsIdMap.set(commentDocumentId, transactionId);
    },
    [transactionsIdMap]
  ), handleSetStatus = (0, import_react.useCallback)(
    ...
    (0, import_react.useMemo)(() => ({ documentValue, permission: "read" }), [documentValue])
  ), threadItemsByStatus = (0, import_react.useMemo)(() => {
  ...
  }, [currentUser, data, documentValue, schemaType, sortOrder, type]), getThreadLength = (0, import_react.useCallback)(
    (threadId) => threadItemsByStatus.open.filter((item) => item.threadId === threadId).length,
    [threadItemsByStatus.open]
  ), getComment = (0, import_react.useCallback)((id) => data == null ? void 0 : data.find((c) => c._id === id), [data]), handleOnCreate = (0, import_react.useCallback)(
    (payload) => {
      var _a, _b;
    ...
    [data, dispatch]
  ), handleOnUpdate = (0, import_react.useCallback)(
    (id, payload) => {
      dispatch({
        type: "COMMENT_UPDATED",
        payload: {
    ...
    [dispatch]
  ), handleOnCreateError = (0, import_react.useCallback)(
    (id, err) => {
      dispatch({
        type: "COMMENT_UPDATED",
        payload: {
  ...
  ), ctxValue = (0, import_react.useMemo)(
    () => ({
      isCreatingDataset,
      status,
...
var CommentsIntentContext = (0, import_react.createContext)(
  void 0
);
var CommentsIntentProvider = (0, import_react.memo)(function(props) {
...
function CommentsOnboardingProvider(props) {
  const { children } = props, [dismissed, setDismissed] = (0, import_react.useState)(getLocalStorage()), handleDismiss = (0, import_react.useCallback)(() => {
    setDismissed(true), setLocalStorage(true);
  }, [setDismissed]), ctxValue = (0, import_react.useMemo)(
    () => ({
...
var CommentsSelectedPathContext = (0, import_react.createContext)(
  null
);
var CommentsSelectedPathProvider = import_react.default.memo(function(props) {
  const { children } = props, [selectedPath, setSelectedPath] = (0, import_react.useState)(null), handleSelectPath = (0, import_react.useCallback)(
    (nextPath) => {
      (0, import_isEqual.default)(selectedPath, nextPath) || setSelectedPath(nextPath);
    },
    [selectedPath]
  ), ctxValue = (0, import_react.useMemo)(
    () => ({
...
var CommentsUpsellContext = (0, import_react.createContext)(null);
var FEATURE$1 = "comments";
var TEMPLATE_OPTIONS$1 = { interpolate: /{{([\s\S]+?)}}/g };
var BASE_URL$1 = "www.sanity.io";
function CommentsUpsellProvider(props) {
  const [upsellDialogOpen, setUpsellDialogOpen] = (0, import_react.useState)(false), [upsellData, setUpsellData] = (0, import_react.useState)(null), projectId = useProjectId(), telemetry = useTelemetry(), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), telemetryLogs = (0, import_react.useMemo)(
    () => ({
    ...
    [telemetry]
  ), handlePrimaryButtonClick = (0, import_react.useCallback)(() => {
    telemetryLogs.dialogPrimaryClicked();
  }, [telemetryLogs]), handleSecondaryButtonClick = (0, import_react.useCallback)(() => {
    telemetryLogs.dialogSecondaryClicked();
  }, [telemetryLogs]), handleClose = (0, import_react.useCallback)(() => {
  ...
  (0, import_react.useEffect)(() => {
    const sub = client.observable.request({
      uri: "/journey/comments"
    }).subscribe({
      next: (data) => {
        if (data)
          try {
            const ctaUrl = (0, import_template.default)(data.ctaButton.url, TEMPLATE_OPTIONS$1);
            data.ctaButton.url = ctaUrl({ baseUrl: BASE_URL$1, projectId });
            const secondaryUrl = (0, import_template.default)(data.secondaryButton.url, TEMPLATE_OPTIONS$1);
  ...
  const handleOpenDialog = (0, import_react.useCallback)(
    (source) => {
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources2-KEPD7YS7.js")
});
...
var ReferenceChildLink = (0, import_react.forwardRef)(function({ documentId, documentType, parentRefPath, children, template: template2, ...rest }, ref) {
  return (0, import_jsx_runtime.jsx)(
    ChildLink,
    {
      ...rest,
...
function ReferencePreviewLink(props) {
  const { onClick, type, value } = props, publishedId = getPublishedId(value == null ? void 0 : value._id), documentPresence = useDocumentPresence(publishedId), documentPreviewStore = useDocumentPreviewStore(), { ReferenceChildLink: ReferenceChildLink2 } = usePaneRouter(), Link2 = (0, import_react.useCallback)(
    function(linkProps) {
      return (0, import_jsx_runtime.jsx)(
        ReferenceChildLink2,
        {
...
function ConfirmDeleteDialogBody({
  ...
  const schema2 = useSchema(), toast = useToast(), { t } = useTranslation2(structureLocaleNamespace), renderPreviewItem = (0, import_react.useCallback)(
    (item) => {
...
var PaneHeader = (0, import_react.forwardRef)(function(props, ref) {
...
function PaneHeaderActionIntentButton(props) {
  const { intent, node } = props, intentLink = useIntentLink({ intent: intent.type, params: intent.params }), handleClick = (0, import_react.useCallback)(
    (event) => {
      intentLink.onClick(event), node.onAction();
    },
    [intentLink, node]
...
var IntentButton = (0, import_react.forwardRef)(function(props, ref) {
  const { intent, ...restProps } = props, Link2 = (0, import_react.useMemo)(
    () => (
  ...
  return (0, import_jsx_runtime.jsx)(
    MenuButton,
    {
      ...
      menu: (0, import_jsx_runtime.jsx)(Menu, { children: templateItems.map((item, itemIndex) => {
        ...
        if (!template2 || !intent)
          return null;
        const Link2 = (0, import_react.forwardRef)(
...
function PaneItem(props) {
  const {
    ...
    marginBottom,
    marginTop
  } = props, schema2 = useSchema(), documentPreviewStore = useDocumentPreviewStore(), { ChildLink: ChildLink2 } = usePaneRouter(), documentPresence = useDocumentPresence(id), hasSchemaType = !!(schemaType && schemaType.name && schema2.get(schemaType.name)), [clicked, setClicked] = (0, import_react.useState)(false), preview = (0, import_react.useMemo)(() => value && isSanityDocument(value) ? !schemaType || !hasSchemaType ? (0, import_jsx_runtime.jsx)(MissingSchemaType, { value }) : (0, import_jsx_runtime.jsx)(
    PaneItemPreview,
    {
      documentPreviewStore,
    ...
    value,
    documentPresence
  ]), Link2 = (0, import_react.useMemo)(
    () => function(linkProps) {
      return (0, import_jsx_runtime.jsx)(ChildLink2, { ...linkProps, childId: id });
    },
    [ChildLink2, id]
  ), handleClick = (0, import_react.useCallback)((e2) => {
    if (e2.metaKey) {
      setClicked(false);
      return;
    }
...
function useNotificationTarget(opts) {
  ...
  return {
    getNotificationValue: (0, import_react.useCallback)(
      ({ commentId }) => {
...
async function createOperation(props) {
  ...
  if (comment.type === "task" && (nextComment = {
    ...
    const {
      ...
      url,
      workspaceTitle
    }, intent = getIntent2 == null ? void 0 : getIntent2({ id: documentId, type: documentType, path: comment.fieldPath }), contentSnapshot = weakenReferencesInContentSnapshot(comment.contentSnapshot);
    nextComment = {
      _id: commentId,
      _type: "comment",
      authorId,
...
function getThrottledFunction(id) {
  if (!throttleFunctionsMap.has(id)) {
    const throttledFunction = (0, import_throttle.default)(postCommentUpdate, THROTTLE_TIME_MS, THROTTLE_SETTINGS);
...
function useCommentOperations(opts) {
  const {
  ...
  ), tools = useTools(), activeTool = (0, import_react.useMemo)(
    () => tools.find((tool) => tool.name === activeToolName),
    [activeToolName, tools]
  ), { getNotificationValue } = useNotificationTarget({ documentId, documentType }), handleCreate = (0, import_react.useCallback)(
    async (comment) => {
  ...
  ), handleRemove = (0, import_react.useCallback)(
    async (id) => {
    ...
    [client, onRemove]
  ), handleUpdate = (0, import_react.useCallback)(
  ...
  ), handleReact = (0, import_react.useCallback)(
    async (id, reaction) => {
...
function useCommentsScroll(opts) {
  const { boundaryElement } = opts || {}, [scrollTarget, setScrollTarget] = (0, import_react.useState)(null), scrollOpts = (0, import_react.useMemo)(() => ({
    ...SCROLL_OPTIONS_BY_TYPE[(scrollTarget == null ? void 0 : scrollTarget.type) || "comment"],
    boundary: boundaryElement
  }), [boundaryElement, scrollTarget == null ? void 0 : scrollTarget.type]), handleScrollToComment = (0, import_react.useCallback)((commentId) => {
    setScrollTarget({ type: "comment", id: commentId });
  }, []), handleScrollToGroup = (0, import_react.useCallback)((threadId) => {
    setScrollTarget({ type: "group", id: threadId });
  }, []), handleScrollToField = (0, import_react.useCallback)((fieldPath) => {
    setScrollTarget({ type: "field", id: fieldPath });
  }, []), handleScrollToInlineComment = (0, import_react.useCallback)((commentId) => {
  ...
  }, [scrollOpts, scrollTarget]), (0, import_react.useMemo)(
    () => ({
...
function useCommentsUpsell() {
  return (0, import_react.useContext)(CommentsUpsellContext) || {
    upsellData: null,
...
function useResolveCommentsEnabled(documentId, documentType) {
  const { enabled: featureEnabled, isLoading, error } = useFeatureEnabled("studioComments"), { enabled } = useSource().document.unstable_comments, enabledFromConfig = (0, import_react.useMemo)(
    () => enabled({ documentType, documentId: getPublishedId(documentId) }),
    [documentId, documentType, enabled]
  );
  return (0, import_react.useMemo)(() => isLoading || !enabledFromConfig || error ? { enabled: false, mode: null } : {
    enabled: true,
...
function CommentsAvatar(props) {
  const { user: userProp, ...restProps } = props, user = userProp, initials = (0, import_react.useMemo)(() => nameToInitials((user == null ? void 0 : user.displayName) || ""), [user == null ? void 0 : user.displayName]);
...
function MentionInlineBlock(props) {
  ...
  return !user || loading ? (0, import_jsx_runtime.jsx)(
    ...
    Tooltip,
    {
      ...
      children: (0, import_jsx_runtime.jsxs)(Span$2, { "data-selected": selected, "data-active": (currentUser == null ? void 0 : currentUser.id) === userId, children: [
        "@",
        user.displayName
      ] })
    }
...
function CommentInputDiscardDialog(props) {
  const { t } = useTranslation2(commentsLocaleNamespace), { onClose, onConfirm } = props, handleCancelClick = (0, import_react.useCallback)(
    (e2) => {
      e2.stopPropagation(), onClose();
    },
    [onClose]
  ), handleConfirmClick = (0, import_react.useCallback)(
    (e2) => {
...
var MentionsMenu$1 = React.forwardRef(function(props, ref) {
  const { t } = useTranslation2(commentsLocaleNamespace), { loading, onSelect, options = [], inputElement } = props, [searchTerm, setSearchTerm] = (0, import_react.useState)(""), commandListRef = (0, import_react.useRef)(null);
  ...
  const renderItem2 = (0, import_react.useCallback)(
    ...
    [options]
  ), filteredOptions = (0, import_react.useMemo)(() => {
    var _a;
    if (!searchTerm)
...
function CommentInputProvider(props) {
  const {
    ...
    value,
    readOnly
  } = props, editor = usePortableTextEditor(), [mentionsMenuOpen, setMentionsMenuOpen] = (0, import_react.useState)(false), [mentionsSearchTerm, setMentionsSearchTerm] = (0, import_react.useState)(""), [selectionAtMentionInsert, setSelectionAtMentionInsert] = (0, import_react.useState)(null), canSubmit = (0, import_react.useMemo)(() => hasCommentMessageValue(value), [value]), hasChanges = useCommentHasChanged(value), focusEditor = (0, import_react.useCallback)(() => {
    readOnly || PortableTextEditor.focus(editor);
  }, [editor, readOnly]), closeMentions = (0, import_react.useCallback)(() => {
    setMentionsMenuOpen(false), setMentionsSearchTerm(""), setSelectionAtMentionInsert(null);
  }, []), openMentions = (0, import_react.useCallback)(() => {
  ...
  }, [editor]), onBeforeInput = (0, import_react.useCallback)(
    (event) => {
  ...
  ), insertAtChar = (0, import_react.useCallback)(() => {
  ...
  const insertMention = (0, import_react.useCallback)(
    (userId) => {
      var _a;
...
function useCursorElement(opts) {
  const { disabled, rootElement } = opts, [cursorRect, setCursorRect] = (0, import_react.useState)(null), cursorElement = (0, import_react.useMemo)(() => cursorRect ? {
    getBoundingClientRect: () => cursorRect
  } : null, [cursorRect]), handleSelectionChange = (0, import_react.useCallback)(() => {
    if (disabled) {
      setCursorRect(null);
      return;
    }
  ...
  return (0, import_react.useEffect)(() => (document.addEventListener("selectionchange", handleSelectionChange, EVENT_LISTENER_OPTIONS), () => {
...
function Editable(props) {
  ...
  } = props, [popoverElement, setPopoverElement] = (0, import_react.useState)(null), rootElementRef = (0, import_react.useRef)(null), editableRef = (0, import_react.useRef)(null), mentionsMenuRef = (0, import_react.useRef)(null), selection = usePortableTextEditorSelection(), {
    canSubmit,
    closeMentions,
    insertMention,
    mentionOptions,
  ...
  }), renderPlaceholder = (0, import_react.useCallback)(
    () => (0, import_jsx_runtime.jsx)(PlaceholderWrapper, { children: placeholder }),
    [placeholder]
  ), handleClickOutside = (0, import_react.useCallback)(() => {
  ...
  ), initialSelectionAtEndOfContent = (0, import_react.useMemo)(() => {
    if (selection)
      return;
  ...
  }, [mentionsSearchTerm]), (0, import_react.useEffect)(() => {
    mentionsMenuOpen && selection && !(0, import_isEqual.default)(selection.anchor, selection.focus) && closeMentions();
...
var CommentInput = (0, import_react.forwardRef)(
  function(props, ref) {
    const {
      avatarSize,
      currentUser,
      ...
      value = EMPTY_ARRAY$d,
      withAvatar = true
    } = props, [focused, setFocused] = (0, import_react.useState)(false), editorRef = (0, import_react.useRef)(null), editorContainerRef = (0, import_react.useRef)(null), [showDiscardDialog, setShowDiscardDialog] = (0, import_react.useState)(false), preDivRef = (0, import_react.useRef)(null), postDivRef = (0, import_react.useRef)(null), innerRef = (0, import_react.useRef)(null), [editorInstanceKey, setEditorInstanceKey] = (0, import_react.useState)(defaultKeyGenerator()), requestFocus = (0, import_react.useCallback)(() => {
      requestAnimationFrame(() => {
        editorRef.current && PortableTextEditor.focus(editorRef.current);
      });
    }, []), resetEditorInstance = (0, import_react.useCallback)(() => {
    ...
    ), scrollToEditor = (0, import_react.useCallback)(() => {
      var _a;
    ...
    }, [onSubmit, requestFocus, resetEditorInstance, scrollToEditor]), handleDiscardConfirm = (0, import_react.useCallback)(() => {
      onDiscardConfirm(), resetEditorInstance();
    }, [onDiscardConfirm, resetEditorInstance]), discardDialogController = (0, import_react.useMemo)(() => ({
      open: () => {
...
var CommentInlineHighlightSpan = (0, import_react.forwardRef)(function(props, ref) {
...
function CommentReactionsMenu(props) {
  const { options, onSelect } = props, { t } = useTranslation2(commentsLocaleNamespace), [focusableElements, setFocusableElements] = (0, import_react.useState)([]), [rootElement, setRootElement] = (0, import_react.useState)(null), [focusedIndex, setFocusedIndex] = (0, import_react.useState)(0), handleRootKeyDown = (0, import_react.useCallback)(
    (event) => {
  ...
  ), handleOptionClick = (0, import_react.useCallback)(
    (event) => {
  ...
  }, [rootElement]), (0, import_react.useEffect)(() => {
...
function CommentReactionsMenuButton(props) {
  const { onMenuClose, onMenuOpen, onSelect, options, readOnly, renderMenuButton: renderMenuButton2, mode } = props, [buttonElement, setButtonElement] = (0, import_react.useState)(null), [popoverElement, setPopoverElement] = (0, import_react.useState)(null), [open, setOpen] = (0, import_react.useState)(false), { t } = useTranslation2(commentsLocaleNamespace), handleClick = (0, import_react.useCallback)(() => {
    const next = !open;
    setOpen(next), next ? onMenuOpen == null || onMenuOpen() : onMenuClose == null || onMenuClose();
  }, [onMenuClose, onMenuOpen, open]), handleClose = (0, import_react.useCallback)(() => {
    open && (setOpen(false), onMenuClose == null || onMenuClose(), buttonElement == null || buttonElement.focus());
  }, [buttonElement, onMenuClose, open]), handleClickOutside = (0, import_react.useCallback)(handleClose, [handleClose]), handleKeyDown = (0, import_react.useCallback)(
    (event) => {
  ...
  const handleSelect = (0, import_react.useCallback)(
    ...
    return (0, import_react.cloneElement)(btn, {
      "aria-expanded": open,
      "aria-haspopup": "true",
...
function CommentReactionsUsersTooltipContent(props) {
  const { currentUser, reactionName, userIds } = props, { t } = useTranslation2(commentsLocaleNamespace), UserList = (0, import_react.useCallback)(() => currentUser ? (0, import_jsx_runtime.jsx)(FormattedUserList, { currentUserId: currentUser.id, userIds }) : null, [currentUser, userIds]);
...
var CommentReactionsBar = import_react.default.memo(function(props) {
  const { currentUser, onSelect, reactions, readOnly, mode } = props, handleSelect = (0, import_react.useCallback)(
    (name) => {
      const option = COMMENT_REACTION_OPTIONS.find((o) => o.shortName === name);
      option && onSelect(option);
    },
    [onSelect]
  ), currentUserReactionNames = (0, import_react.useMemo)(() => reactions.filter((r) => r.userId === (currentUser == null ? void 0 : currentUser.id)).map((r) => r.shortName), [currentUser == null ? void 0 : currentUser.id, reactions]), groupedReactions = (0, import_react.useMemo)(() => groupReactionsByName(reactions).filter(([name]) => COMMENT_REACTION_EMOJIS[name]), [reactions]), sortOrder = (0, import_react.useRef)(Object.keys(Object.fromEntries(groupedReactions))), sortedReactions = (0, import_react.useMemo)(() => {
...
function CommentsListItemReferencedValue(props) {
  const { hasReferencedValue, value } = props, { t } = useTranslation(commentsLocaleNamespace), tooltipText = t("list-item.missing-referenced-value-tooltip-content"), resolvedValue = (0, import_react.useMemo)(() => {
...
function CommentsListItemLayout(props) {
  ...
  const {
    ...
    readOnly,
    withAvatar = true
  } = props, { _createdAt, authorId, message, _id, lastEditedAt } = comment, [user] = useUser(authorId), { t } = useTranslation2(commentsLocaleNamespace), [value, setValue] = (0, import_react.useState)(message), [isEditing, setIsEditing] = (0, import_react.useState)(false), [rootElement, setRootElement] = (0, import_react.useState)(null), startMessage = (0, import_react.useRef)(message), [menuOpen, setMenuOpen] = (0, import_react.useState)(false), commentInputRef = (0, import_react.useRef)(null), hasChanges = useCommentHasChanged(value), hasValue = (0, import_react.useMemo)(() => hasCommentMessageValue(value), [value]), reactions = (0, import_react.useMemo)(
    () => {
      var _a2;
  ...
  const handleMenuOpen = (0, import_react.useCallback)(() => setMenuOpen(true), []), handleMenuClose = (0, import_react.useCallback)(() => setMenuOpen(false), []), handleCopyLink = (0, import_react.useCallback)(() => onCopyLink == null ? void 0 : onCopyLink(_id), [_id, onCopyLink]), handleCreateRetry = (0, import_react.useCallback)(
    (e2) => {
      e2.stopPropagation(), onCreateRetry == null || onCreateRetry(_id);
    },
    [_id, onCreateRetry]
  ), handleDelete = (0, import_react.useCallback)(() => onDelete(_id), [_id, onDelete]), cancelEdit = (0, import_react.useCallback)(() => {
    setIsEditing(false), setValue(startMessage.current);
  }, []), startDiscard = (0, import_react.useCallback)(() => {
    var _a2;
  ...
  }, [cancelEdit, hasChanges, hasValue]), handleInputKeyDown = (0, import_react.useCallback)(
    (event) => {
  ...
  ), cancelDiscard = (0, import_react.useCallback)(() => {
    var _a2;
    (_a2 = commentInputRef.current) == null || _a2.discardDialogController.close();
  }, []), confirmDiscard = (0, import_react.useCallback)(() => {
    var _a2;
    (_a2 = commentInputRef.current) == null || _a2.discardDialogController.close(), cancelEdit();
  }, [cancelEdit]), handleReactionSelect = (0, import_react.useCallback)(
    (reaction) => {
      onReactionSelect == null || onReactionSelect(_id, reaction);
    },
    [_id, onReactionSelect]
  ), handleEditSubmit = (0, import_react.useCallback)(() => {
    onEdit(_id, { message: value }), setIsEditing(false);
  }, [_id, onEdit, value]), handleOpenStatusChange = (0, import_react.useCallback)(() => {
    onStatusChange == null || onStatusChange(_id, comment.status === "open" ? "resolved" : "open");
  }, [_id, comment.status, onStatusChange]), toggleEdit = (0, import_react.useCallback)(() => {
    setIsEditing((v) => !v);
  }, []), handleCloseMenu = (0, import_react.useCallback)(() => setMenuOpen(false), []), handleClickOutside = (0, import_react.useCallback)(() => {
    hasChanges || cancelEdit();
  }, [cancelEdit, hasChanges]), handleRootKeyDown = (0, import_react.useCallback)(
    (event) => {
...
var GhostButton = ut.button`
  ...
  left: 0;
`;
var CommentsListItem = import_react.default.memo(function(props) {
  var _a, _b, _c, _d, _e;
  const {
  ...
  } = props, { t } = useTranslation2(commentsLocaleNamespace), [value, setValue] = (0, import_react.useState)(EMPTY_ARRAY$a), [collapsed, setCollapsed] = (0, import_react.useState)(true), didExpand = (0, import_react.useRef)(false), replyInputRef = (0, import_react.useRef)(null), { isTopLayer } = useLayer(), hasValue = (0, import_react.useMemo)(() => hasCommentMessageValue(value), [value]), [mouseOver, setMouseOver] = (0, import_react.useState)(false), handleMouseEnter = (0, import_react.useCallback)(() => setMouseOver(true), []), handleMouseLeave = (0, import_react.useCallback)(() => setMouseOver(false), []), handleReplySubmit = (0, import_react.useCallback)(() => {
    var _a2;
    const nextComment = {
      message: value,
  ...
  }, [hasValue]), handleInputKeyDown = (0, import_react.useCallback)(
    (event) => {
  ...
  }, []), handleThreadRootClick = (0, import_react.useCallback)(
    (e2) => {
      var _a2;
...
function CreateNewThreadInput(props) {
  const {
    ...
    onNewThreadCreate,
    readOnly
  } = props, { t } = useTranslation2(commentsLocaleNamespace), [value, setValue] = (0, import_react.useState)(EMPTY_ARRAY$b), commentInputHandle = (0, import_react.useRef)(null), handleSubmit = (0, import_react.useCallback)(() => {
    onNewThreadCreate == null || onNewThreadCreate(value), setValue(EMPTY_ARRAY$b);
  }, [onNewThreadCreate, value]), hasValue = (0, import_react.useMemo)(() => hasCommentMessageValue(value), [value]), startDiscard = (0, import_react.useCallback)(() => {
    var _a;
...
function CommentThreadLayout(props) {
  const {
    ...
    onPathSelect,
    readOnly
  } = props, { t } = useTranslation2(commentsLocaleNamespace), handleNewThreadCreate = (0, import_react.useCallback)(
    (payload) => {
      const nextComment = {
        message: payload,
  ...
  ), handleBreadcrumbsClick = (0, import_react.useCallback)(
    (e2) => {
  ...
  ), handleNewThreadClick = (0, import_react.useCallback)(
    (e2) => {
    ...
    [fieldPath, onPathSelect]
  ), crumbsTitlePath = (0, import_react.useMemo)(() => (breadcrumbs == null ? void 0 : breadcrumbs.map((p) => p.title)) || [], [breadcrumbs]), lastCrumb = crumbsTitlePath[crumbsTitlePath.length - 1];
...
var CommentsListInner = (0, import_react.forwardRef)(function(props, ref) {
  const {
    beforeListNode,
    comments: comments2,
    currentUser,
    ...
    selectedPath,
    status
  } = props, [boundaryElement, setBoundaryElement] = (0, import_react.useState)(null), groupedThreads = (0, import_react.useMemo)(() => Object.entries(groupThreads(comments2)), [comments2]), showComments = !loading && !error && groupedThreads.length > 0;
  return (0, import_jsx_runtime.jsxs)(
    Flex,
    {
  ...
  return (0, import_jsx_runtime.jsx)(Container, { width: 1, children: (0, import_jsx_runtime.jsx)(Box, { marginBottom: 6, children: (0, import_jsx_runtime.jsxs)(Card, { radius: 3, overflow: "hidden", border: true, children: [
    ...
    (0, import_jsx_runtime.jsxs)(Box, { padding: 3, marginTop: 2, children: [
      ...
      (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, justify: "flex-end", marginTop: 5, children: [
        data.secondaryButton.text && (0, import_jsx_runtime.jsx)(
          Button2,
          {
            mode: "bleed",
            text: data.secondaryButton.text,
...
function CommentsDocumentLayoutInner(props) {
  const { documentId, documentType } = props, commentsEnabled = useCommentsEnabled(), { openInspector, inspector } = useDocumentPane(), handleOpenCommentsInspector = (0, import_react.useCallback)(() => {
...
function CommentsFieldButton(props) {
  const {
    ...
    open,
    value
  } = props, { t } = useTranslation2(commentsLocaleNamespace), [popoverElement, setPopoverElement] = (0, import_react.useState)(null), [addCommentButtonElement, setAddCommentButtonElement] = (0, import_react.useState)(
    null
  ), commentInputHandle = (0, import_react.useRef)(null), hasComments = count > 0, closePopover = (0, import_react.useCallback)(() => {
    open && (onClose(), addCommentButtonElement == null || addCommentButtonElement.focus());
  }, [addCommentButtonElement, open, onClose]), handleSubmit = (0, import_react.useCallback)(() => {
    onCommentAdd(), closePopover();
  }, [closePopover, onCommentAdd]), hasValue = (0, import_react.useMemo)(() => hasCommentMessageValue(value), [value]), startDiscard = (0, import_react.useCallback)(() => {
    var _a;
    if (!hasValue) {
      closePopover();
      return;
  ...
  }, [closePopover, hasValue]), handleInputKeyDown = (0, import_react.useCallback)(
    (event) => {
      event.isDefaultPrevented() || onInputKeyDown && onInputKeyDown(event);
    },
    [onInputKeyDown]
  ), handleDiscardCancel = (0, import_react.useCallback)(() => {
    var _a;
    (_a = commentInputHandle.current) == null || _a.discardDialogController.close();
  }, []), handleDiscardConfirm = (0, import_react.useCallback)(() => {
    var _a;
    (_a = commentInputHandle.current) == null || _a.discardDialogController.close(), closePopover(), onDiscard();
  }, [closePopover, onDiscard]), handlePopoverKeyDown = (0, import_react.useCallback)(
    (event) => {
...
function CommentFieldInner(props) {
  const { mode } = props, currentUser = useCurrentUser(), { element: boundaryElement } = useBoundaryElement(), rootRef = (0, import_react.useRef)(null), {
    comments: comments2,
    isCommentsOpen,
    isCreatingDataset,
    mentionOptions,
    ...
    boundaryElement
  }), fieldTitle = (0, import_react.useMemo)(() => getSchemaTypeTitle(props.schemaType), [props.schemaType]), stringPath = (0, import_react.useMemo)(() => toString(props.path), [props.path]), cachedValue = messageCache.get(stringPath) || null, [value, setValue] = (0, import_react.useState)(cachedValue), isOpen = (0, import_react.useMemo)(() => authoringPath === stringPath, [authoringPath, stringPath]), isSelected = (0, import_react.useMemo)(() => !isCommentsOpen || (selectedPath == null ? void 0 : selectedPath.origin) === "form" || (selectedPath == null ? void 0 : selectedPath.origin) === "url" ? false : (selectedPath == null ? void 0 : selectedPath.fieldPath) === stringPath, [isCommentsOpen, selectedPath == null ? void 0 : selectedPath.fieldPath, selectedPath == null ? void 0 : selectedPath.origin, stringPath]), isInlineCommentThread = (0, import_react.useMemo)(() => comments2.data.open.filter((c) => c.threadId === (selectedPath == null ? void 0 : selectedPath.threadId)).some((x) => isTextSelectionComment(x.parentComment)), [comments2.data.open, selectedPath == null ? void 0 : selectedPath.threadId]), count = (0, import_react.useMemo)(() => comments2.data.open.map((c) => c.fieldPath === stringPath ? c.commentsCount : 0).reduce((acc, val) => acc + val, 0) || 0, [comments2.data.open, stringPath]), hasComments = count > 0, resetMessageValue = (0, import_react.useCallback)(() => {
    setValue(null), messageCache.delete(stringPath);
  }, [stringPath]), handleClick = (0, import_react.useCallback)(() => {
    var _a;
    if (hasComments) {
    ...
    stringPath,
    upsellData
  ]), handleCommentAdd = (0, import_react.useCallback)(() => {
    if (value) {
    ...
    status,
    value
  ]), handleClose = (0, import_react.useCallback)(() => setAuthoringPath(null), [setAuthoringPath]), handleOnChange = (0, import_react.useCallback)(
    (nextValue) => {
      setValue(nextValue), messageCache.set(stringPath, nextValue);
    },
    [stringPath]
  ), internalComments = (0, import_react.useMemo)(
    () => ({
...
function useRectFromElements(props) {
  const { scrollElement, disabled, selector } = props, [rect, setRect] = (0, import_react.useState)(null), handleSetRect = (0, import_react.useCallback)(() => {
  ...
  }, [handleSetRect, disabled]), (0, import_react.useEffect)(() => {
...
function useAuthoringReferenceElement(props) {
  ...
  return (0, import_react.useMemo)(() => rect ? {
...
function FloatingButtonPopover(props) {
  const { disabled, onClick, onClickOutside, referenceElement } = props, [popoverElement, setPopoverElement] = (0, import_react.useState)(null), { t } = useTranslation(commentsLocaleNamespace);
...
function InlineCommentInputPopover(props) {
  const {
    ...
    referenceElement,
    value
  } = props, commentInputRef = (0, import_react.useRef)(null), [contentElement, setContentElement] = (0, import_react.useState)(null), handleDiscardConfirm = (0, import_react.useCallback)(() => {
    var _a;
    (_a = commentInputRef.current) == null || _a.discardDialogController.close(), onDiscardConfirm();
  }, [onDiscardConfirm]), handleDiscardCancel = (0, import_react.useCallback)(() => {
    var _a;
...
var CommentsPortableTextInputInner = import_react.default.memo(function(props) {
  var _a, _b;
  const { mode } = props, currentUser = useCurrentUser(), portal = usePortal(), { comments: comments2, getComment, mentionOptions, onCommentsOpen, operation, setStatus, status } = useComments(), { setSelectedPath, selectedPath } = useCommentsSelectedPath(), { scrollToComment, scrollToGroup } = useCommentsScroll(), { handleOpenDialog } = useCommentsUpsell(), editorRef = (0, import_react.useRef)(null), mouseDownRef = (0, import_react.useRef)(false), [nextCommentValue, setNextCommentValue] = (0, import_react.useState)(null), [nextCommentSelection, setNextCommentSelection] = (0, import_react.useState)(null), [currentSelection, setCurrentSelection] = (0, import_react.useState)(null), [currentSelectionRect, setCurrenSelectionRect] = (0, import_react.useState)(null), [currentHoveredCommentId, setCurrentHoveredCommentId] = (0, import_react.useState)(null), [canSubmit, setCanSubmit] = (0, import_react.useState)(false), [rootElement, setRootElement] = (0, import_react.useState)(null), [isFullScreen, setIsFullScreen] = (0, import_react.useState)(false), [addedCommentsDecorations, setAddedCommentsDecorations] = (0, import_react.useState)(EMPTY_ARRAY$8), stringFieldPath = (0, import_react.useMemo)(() => toString(props.path), [props.path]), handleSetCurrentSelectionRect = (0, import_react.useCallback)(() => {
    const rect = getSelectionBoundingRect();
    setCurrenSelectionRect(rect);
  }, []), resetStates = (0, import_react.useCallback)(() => {
  ...
  }, []), handleSelectCurrentSelection = (0, import_react.useCallback)(() => {
    if (mode === "upsell") {
      handleOpenDialog("pte");
      return;
    }
    setNextCommentSelection(currentSelection);
  }, [currentSelection, handleOpenDialog, mode]), handleCommentDiscardConfirm = (0, import_react.useCallback)(() => {
    resetStates();
  }, [resetStates]), textComments = (0, import_react.useMemo)(() => comments2.data.open.filter((comment) => comment.fieldPath === stringFieldPath).filter((c) => isTextSelectionComment(c.parentComment)).map((c) => c.parentComment), [comments2.data.open, stringFieldPath]), getFragment = (0, import_react.useCallback)(() => editorRef.current ? PortableTextEditor.getFragment(editorRef.current) : EMPTY_ARRAY$8, []), handleSubmit = (0, import_react.useCallback)(() => {
    ...
    resetStates,
    setStatus
  ]), handleDecoratorClick = (0, import_react.useCallback)(
    (commentId) => {
      var _a2;
  ...
  ), handleSelectionChange = (0, import_react.useCallback)(
    (selection) => {
  ...
  ), debounceSelectionChange = (0, import_react.useMemo)(
    () => (0, import_debounce.default)(handleSelectionChange, 200),
    [handleSelectionChange]
  ), handleMouseDown = (0, import_react.useCallback)(() => {
    mouseDownRef.current = true;
  }, []), handleMouseUp = (0, import_react.useCallback)(() => {
    mouseDownRef.current = false, handleSetCurrentSelectionRect();
  }, [handleSetCurrentSelectionRect]), handleRangeDecorationMoved = (0, import_react.useCallback)((details) => {
    var _a2;
  ...
  }, []), updateCommentRange = (0, import_react.useCallback)(() => {
  ...
  }, [addedCommentsDecorations, getComment, operation]), handleBuildRangeDecorations = (0, import_react.useCallback)(
    (commentsToDecorate) => {
  ...
  ), onEditorChange = (0, import_react.useCallback)(
    (change) => {
  ...
  ), authoringDecoration = (0, import_react.useMemo)(() => nextCommentSelection ? {
    component: ({ children }) => (0, import_jsx_runtime.jsx)(CommentInlineHighlightSpan, { isAuthoring: true, children }),
    selection: nextCommentSelection
  } : null, [nextCommentSelection]), rangeDecorations = (0, import_react.useMemo)(() => [
  ...
  ], [addedCommentsDecorations, authoringDecoration, props == null ? void 0 : props.rangeDecorations]), currentSelectionIsOverlapping = (0, import_react.useMemo)(() => !currentSelection || addedCommentsDecorations.length === 0 ? false : addedCommentsDecorations.some((d) => {
    if (!editorRef.current)
      return false;
  ...
  }), selectionReferenceElement = (0, import_react.useMemo)(() => currentSelectionRect ? {
  ...
  }, [currentSelection, scrollElement, handleSetCurrentSelectionRect]), (0, import_react.useEffect)(() => {
...
var FEEDBACK_FORM_LINK$1 = "https://snty.link/comments-beta-feedback";
var Span$1 = ut.span`
  margin-right: 0.2em;
`;
var Link$1 = ut.a`
...
function CommentsInspectorFeedbackFooter() {
  ...
  return (0, import_jsx_runtime.jsx)(FooterCard, { padding: 4, children: (0, import_jsx_runtime.jsxs)(Text, { muted: true, size: 1, children: [
    ...
    " ",
    (0, import_jsx_runtime.jsxs)(Link$1, { href: FEEDBACK_FORM_LINK$1, target: "_blank", rel: "noreferrer", children: [
      (0, import_jsx_runtime.jsxs)(Span$1, { children: [
...
var CommentsInspectorHeader = (0, import_react.forwardRef)(function(props, ref) {
  const { t } = useTranslation2(commentsLocaleNamespace), { onClose, onViewChange, view, mode } = props, handleSetOpenView = (0, import_react.useCallback)(() => onViewChange("open"), [onViewChange]), handleSetResolvedView = (0, import_react.useCallback)(() => onViewChange("resolved"), [onViewChange]);
...
function CommentsInspectorInner(props) {
  const { t } = useTranslation2(commentsLocaleNamespace), { onClose, mode } = props, [showDeleteDialog, setShowDeleteDialog] = (0, import_react.useState)(false), [commentToDelete, setCommentToDelete] = (0, import_react.useState)(null), [deleteLoading, setDeleteLoading] = (0, import_react.useState)(false), [deleteError, setDeleteError] = (0, import_react.useState)(null), rootRef = (0, import_react.useRef)(null), currentUser = useCurrentUser(), { params, createPathWithParams, setParams } = usePaneRouter(), uniqueParams = useUnique(params) || EMPTY_PARAMS$1, commentIdParamRef = (0, import_react.useRef)(uniqueParams == null ? void 0 : uniqueParams.comment), didScrollToCommentFromParam = (0, import_react.useRef)(false), pushToast = useToast().push, { isTopLayer } = useLayer(), { onPathOpen, connectionState } = useDocumentPane(), { scrollToComment, scrollToField, scrollToInlineComment } = useCommentsScroll(), { selectedPath, setSelectedPath } = useCommentsSelectedPath(), { isDismissed, setDismissed } = useCommentsOnboarding(), { comments: comments2, getComment, isCreatingDataset, mentionOptions, setStatus, status, operation } = useComments(), { upsellData, telemetryLogs } = useCommentsUpsell(), currentComments = (0, import_react.useMemo)(() => comments2.data[status], [comments2, status]), loading = (0, import_react.useMemo)(() => comments2.loading || connectionState === "connecting", [comments2.loading, connectionState]);
  (0, import_react.useEffect)(() => (mode === "upsell" && ((selectedPath == null ? void 0 : selectedPath.origin) === "form" ? telemetryLogs.panelViewed("field_action") : commentIdParamRef.current ? telemetryLogs.panelViewed("link") : telemetryLogs.panelViewed("document_action")), () => {
    mode === "upsell" && telemetryLogs.panelDismissed();
  }), []);
  const handleChangeView = (0, import_react.useCallback)(
    (nextView) => {
      setStatus(nextView), setSelectedPath(null);
    },
    [setSelectedPath, setStatus]
  ), handleCloseInspector = (0, import_react.useCallback)(() => {
    onClose(), setSelectedPath(null);
  }, [onClose, setSelectedPath]), handleCopyLink = (0, import_react.useCallback)(
    (id) => {
      const path = createPathWithParams({
        ...params,
        comment: id
  ...
  ), handleCreateRetry = (0, import_react.useCallback)(
    (id) => {
      var _a;
  ...
  ), closeDeleteDialog = (0, import_react.useCallback)(() => {
    deleteLoading || (setShowDeleteDialog(false), setCommentToDelete(null));
  }, [deleteLoading]), handlePathSelect = (0, import_react.useCallback)(
    (nextPath) => {
  ...
  ), handleNewThreadCreate = (0, import_react.useCallback)(
    (nextComment) => {
      var _a;
  ...
  ), handleReply = (0, import_react.useCallback)(
    (nextComment) => {
      var _a;
      operation.create({
        ...nextComment,
    ...
    [operation]
  ), handleEdit = (0, import_react.useCallback)(
    (id, nextComment) => {
      operation.update(id, nextComment);
    },
    [operation]
  ), onDeleteStart = (0, import_react.useCallback)(
    (id) => {
      var _a;
    ...
    [currentComments]
  ), handleDeleteConfirm = (0, import_react.useCallback)(
    async (id) => {
      try {
  ...
  ), handleStatusChange = (0, import_react.useCallback)(
    (id, nextStatus) => {
      var _a;
  ...
  ), handleReactionSelect = (0, import_react.useCallback)(
    (id, reaction) => {
      operation.react(id, reaction);
    },
    [operation]
  ), handleDeselectPath = (0, import_react.useCallback)(() => {
    selectedPath && isTopLayer && setSelectedPath(null);
  }, [isTopLayer, selectedPath, setSelectedPath]), handleClickOutside = (0, import_react.useCallback)(
    (e2) => {
      var _a;
  ...
  useClickOutside(handleClickOutside, [rootRef.current]), (0, import_react.useEffect)(() => {
    var _a;
  ...
  const beforeListNode = (0, import_react.useMemo)(() => mode === "upsell" && upsellData ? (0, import_jsx_runtime.jsx)(
    CommentsUpsellPanel,
    {
      data: upsellData,
...
var StructureToolContext = (0, import_react.createContext)(null);
...
function useStructureToolSetting(namespace, key, defaultValue) {
  ...
  const set2 = (0, import_react.useCallback)(
    (newValue) => {
...
var Timeline = ({
  ...
  ), renderItem2 = (0, import_react.useCallback)(
    (chunk, { activeIndex }) => {
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  const { children, index, pane: pane2, paneKey, onFocusPath } = props, schema2 = useSchema(), templates = useTemplates(), {
    __internal_tasks,
    document: {
    ...
    title = null,
    views: viewsProp = []
  } = pane2, paneOptions = useUnique(options), documentIdRaw = paneOptions.id, documentId = getPublishedId(documentIdRaw), documentType = options.type, params = useUnique(paneRouter.params) || EMPTY_PARAMS$2, panePayload = useUnique(paneRouter.payload), { templateName, templateParams } = (0, import_react.useMemo)(
  ...
  ), focusPathRef = (0, import_react.useRef)(focusPath), openPathRef = (0, import_react.useRef)([]), activeViewId = params.view || views2[0] && views2[0].id || null, [timelineMode, setTimelineMode] = (0, import_react.useState)("closed"), [timelineError, setTimelineError] = (0, import_react.useState)(null), timelineStore = useTimelineStore({
    documentId,
    documentType,
  ...
  const setOpenPath = (0, import_react.useCallback)(
    ...
    (nextFocusPath) => {
      (0, import_react_fast_compare.default)(focusPathRef.current, nextFocusPath) || (setFocusPath(nextFocusPath), focusPathRef.current = nextFocusPath, openPathRef.current = nextFocusPath, onFocusPath == null || onFocusPath(nextFocusPath)), presenceStore.setLocation([
        {
          type: "document",
          documentId,
          path: nextFocusPath,
  ...
  return (0, import_react.useEffect)(() => {
    ...
    if (ready && params.path) {
      ...
      disableBlurRef.current = true, setFocusPath(pathFromUrl), (0, import_react_fast_compare.default)(openPathRef.current, pathFromUrl) || (openPathRef.current = pathFromUrl, setOpenPath(pathFromUrl)), (0, import_react_fast_compare.default)(focusPathRef.current, pathFromUrl) || (focusPathRef.current = pathFromUrl, onFocusPath == null || onFocusPath(pathFromUrl));
      const timeout = setTimeout(() => {
...
function DocumentListPaneContent(props) {
  const {
    ...
    searchInputElement,
    showIcons
  } = props, schema2 = useSchema(), { collapsed: layoutCollapsed } = usePaneLayout(), { collapsed, index } = usePane(), [shouldRender, setShouldRender] = (0, import_react.useState)(false), { t } = useTranslation2(structureLocaleNamespace), handleEndReached = (0, import_react.useCallback)(() => {
...
var DocumentListPaneHeader = (0, import_react.memo)(
  ({
    contentAfter,
    index,
...
function useDocumentList(opts) {
  ...
  }), { unstable_enableNewSearch = false } = useWorkspace().search, schema2 = useSchema(), maxFieldDepth = useSearchMaxFieldDepth(), [resultState, setResult] = (0, import_react.useState)(INITIAL_STATE$1), { onRetry, error, result } = resultState, documents = result == null ? void 0 : result.documents, items = (0, import_react.useMemo)(
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    return (_a = item.params) != null && _a.layout ? {
      ...
      ...item,
      selected: (0, import_isEqual.default)(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$5)
    } : { ...item, selected: false };
  });
};
var DocumentListPane = (0, import_react.memo)(function(props) {
  const { childItemId, index, isActive, isSelected, pane: pane2, paneKey } = props, schema2 = useSchema(), { name: parentSourceName } = useSource(), {
  ...
  const loadingVariant = (0, import_react.useMemo)(() => isLoading && items.length === 0 && showSearchLoadingRef.current ? "spinner" : "initial", [isLoading, items.length]), searchInput = (0, import_jsx_runtime.jsx)(Box, { paddingX: 3, paddingBottom: 3, children: (0, import_jsx_runtime.jsx)(
    TextInput,
    {
...
var __publicField$e = (obj, key, value) => (__defNormalProp$e(obj, typeof key != "symbol" ? key + "" : key, value), value);
var SerializeError = class extends Error {
  constructor(message, parentPath, pathSegment, hint) {
    super(message), __publicField$e(this, "path"), __publicField$e(this, "helpId");
...
var __publicField$d = (obj, key, value) => (__defNormalProp$d(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$c = (obj, key, value) => (__defNormalProp$c(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$b = (obj, key, value) => (__defNormalProp$b(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$a = (obj, key, value) => (__defNormalProp$a(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$9 = (obj, key, value) => (__defNormalProp$9(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$8 = (obj, key, value) => (__defNormalProp$8(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$7 = (obj, key, value) => (__defNormalProp$7(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$6 = (obj, key, value) => (__defNormalProp$6(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$5 = (obj, key, value) => (__defNormalProp$5(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var __publicField$4 = (obj, key, value) => (__defNormalProp$4(obj, typeof key != "symbol" ? key + "" : key, value), value);
...
var tasksUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-MWIMOH3D.js")
});
...
function DueByChange({ date }) {
  ...
  return (0, import_jsx_runtime.jsx)(Strong, { children: (0, import_jsx_runtime.jsx)(NoWrap, { children: formattedDate }) });
}
...
var EditedAt = (0, import_react.memo)(
  function(props) {
    ...
    return (0, import_jsx_runtime.jsxs)(Flex, { gap: 1, children: [
      ...
      (0, import_jsx_runtime.jsxs)(Text, { muted: true, size: 1, children: [
        ...
        " •",
        " ",
        (0, import_jsx_runtime.jsx)(Tooltip, { content: formattedDate, placement: "top-end", children: (0, import_jsx_runtime.jsx)(NoWrap, { children: (0, import_jsx_runtime.jsx)("time", { dateTime: formattedDate, children: timeAgo }) }) })
      ] })
    ] });
  },
  (prevProps, nextProps) => prevProps.activity.timestamp === nextProps.activity.timestamp
);
var TasksEnabledContext = (0, import_react.createContext)(null);
function TasksEnabledProvider({ children }) {
  var _a;
  const { enabled, isLoading } = useFeatureEnabled("sanityTasks"), isWorkspaceEnabled = (_a = useWorkspace().tasks) == null ? void 0 : _a.enabled, value = (0, import_react.useMemo)(() => !isWorkspaceEnabled || isLoading ? {
    enabled: false,
    mode: null
  } : {
    enabled: true,
...
function useTasksEnabled() {
  const context = (0, import_react.useContext)(TasksEnabledContext);
  if (!context)
    throw new Error("useTasks must be used within a TasksEnabledProvider");
  return context;
}
var MentionUserContext = (0, import_react.createContext)(null);
function MentionUserProvider(props) {
  const [selectedDocument, setSelectedDocument] = (0, import_react.useState)(null), mentionOptions = useUserListWithPermissions({
...
function useMentionUser() {
  const context = (0, import_react.useContext)(MentionUserContext);
  if (!context)
    throw new Error("useMentionUser must be used within a MentionUserProvider");
  return context;
}
var TasksNavigationContext = (0, import_react.createContext)(null);
...
var TasksNavigationProvider = ({ children }) => {
  const [state2, dispatch] = (0, import_react.useReducer)(reducer, initialState), router2 = useRouter(), toast = useToast(), telemetry = useTelemetry(), setViewMode = (0, import_react.useCallback)((viewMode) => {
  ...
  }, []), setActiveTab = (0, import_react.useCallback)((tabId) => {
    dispatch({ type: "SET_ACTIVE_TAB", payload: tabId });
  }, []), handleCloseTasks = (0, import_react.useCallback)(() => {
    dispatch({ type: "TOGGLE_TASKS_VIEW", payload: false });
  }, []), handleOpenTasks = (0, import_react.useCallback)(() => {
    dispatch({ type: "TOGGLE_TASKS_VIEW", payload: true });
  }, []), handleCopyLinkToTask = (0, import_react.useCallback)(() => {
  ...
  }, [state2.selectedTask, state2.viewMode, telemetry, toast]), searchParamsAsString = new URLSearchParams(router2.state._searchParams).toString();
  return (0, import_react.useEffect)(() => {
    if (searchParamsAsString) {
      ...
      viewMode === "edit" && selectedTask && (dispatch({ type: "EDIT_TASK", payload: { id: selectedTask } }), telemetry.log(TaskLinkOpened));
    }
  }, [searchParamsAsString, telemetry]), (0, import_jsx_runtime.jsx)(
...
function useTasksNavigation() {
  return (0, import_react.useContext)(TasksNavigationContext) || {
    state: {
      activeTabId: "assigned",
      viewMode: "list",
      selectedTask: null,
...
function useTasksStore(opts) {
  const { client } = useAddonDataset(), { documentId } = opts, [state2, dispatch] = (0, import_react.useReducer)(tasksReducer, INITIAL_STATE), [isLoading, setIsLoading] = (0, import_react.useState)(client !== null), [error, setError] = (0, import_react.useState)(null), params = (0, import_react.useMemo)(
    () => ({ documentId: documentId ? getPublishedId(documentId) : null }),
    [documentId]
  ), initialFetch = (0, import_react.useCallback)(async () => {
    if (!client) {
      setIsLoading(false);
      return;
    }
  ...
  return (0, import_react.useEffect)(() => {
    ...
    data: (0, import_react.useMemo)(() => Object.values(state2.tasks), [state2.tasks]),
    dispatch,
    error,
    isLoading
  };
...
function TasksProvider(props) {
  const { children } = props, [activeDocument, setActiveDocument] = (0, import_react.useState)(null), { data = EMPTY_ARRAY$4, isLoading } = useTasksStore({}), debouncedSetActiveDocument = (0, import_react.useCallback)((0, import_debounce.default)(setActiveDocument, 1e3), []), value = (0, import_react.useMemo)(
    () => ({
      activeDocument,
...
function useTasks() {
  return (0, import_react.useContext)(TasksContext) || {
    activeDocument: null,
...
function TasksUserAvatar(props) {
  ...
  return loading ? (0, import_jsx_runtime.jsx)(AvatarSkeleton, { $size: size, animated: true }) : !user || !loadedUser ? (0, import_jsx_runtime.jsx)(AvatarRoot, { $size: size, $border: border, children: (0, import_jsx_runtime.jsx)(Text, { size, children: (0, import_jsx_runtime.jsx)(UserIcon, {}) }) }) : (0, import_jsx_runtime.jsx)(
    Tooltip,
    {
      ...
      placement: "top-end",
      children: (0, import_jsx_runtime.jsx)(AvatarRoot, { $size: size, $removeBg: !!(loadedUser != null && loadedUser.imageUrl), children: (0, import_jsx_runtime.jsx)(
        UserAvatar,
        {
          user: loadedUser,
          size,
...
var ActivityChildrenRoot = ut(Flex)`
  height: 100%;
`;
...
function ActivityItem({ avatarPaddingTop = 1, userId, children }) {
  return (0, import_jsx_runtime.jsxs)(Flex, { children: [
    (0, import_jsx_runtime.jsx)(Box, { marginRight: 3, paddingTop: avatarPaddingTop, children: (0, import_jsx_runtime.jsx)(TasksUserAvatar, { user: { id: userId }, size: 0 }) }),
    (0, import_jsx_runtime.jsx)(ActivityChildrenRoot, { align: "center", flex: 1, children: (0, import_jsx_runtime.jsx)(ActivityItemChildrenContainer, { children }) })
  ] });
}
function TasksActivityCommentInput(props) {
  const { mentionOptions, currentUser, onSubmit } = props, { mode } = useTasksEnabled(), [value, setValue] = (0, import_react.useState)(null), editorRef = (0, import_react.useRef)(null), hasValue = (0, import_react.useMemo)(() => hasCommentMessageValue(value), [value]), handleChange = (0, import_react.useCallback)((nextValue) => {
    setValue(nextValue);
  }, []), handleSubmit = (0, import_react.useCallback)(() => {
    hasValue && (onSubmit(value), setValue(null));
  }, [hasValue, onSubmit, value]), handleDiscardCancel = (0, import_react.useCallback)(() => {
    var _a;
  ...
  return (0, import_jsx_runtime.jsx)(ActivityItem, { userId: currentUser.id, avatarPaddingTop: 3, children: (0, import_jsx_runtime.jsx)(Card, { tone: "transparent", radius: 3, padding: 2, children: (0, import_jsx_runtime.jsx)(
    CommentInput,
    {
      withAvatar: false,
      currentUser,
      ...
      placeholder: t(mode === "upsell" ? "panel.comment.placeholder.upsell" : "panel.comment.placeholder"),
      ref: editorRef,
      value
    }
  ) }) });
...
var CommentListItemRoot = ut.div((props) => {
  const theme = getTheme_v2(props.theme);
  return at`
    [data-ui='comments-list-item'] {
...
function TasksActivityCommentItem(props) {
  const { parentComment } = props, { mode } = useTasksEnabled();
  return (0, import_jsx_runtime.jsx)(ActivityItem, { userId: parentComment.authorId, avatarPaddingTop: 3, children: (0, import_jsx_runtime.jsx)(CommentListItemRoot, { children: (0, import_jsx_runtime.jsx)(
    CommentsListItem,
    {
      ...props,
...
var UserSkeleton = ut(TextSkeleton)`
  ...
  width: '100%';
`;
var TasksActivityCreatedAt = (0, import_react.memo)(
  function(props) {
    var _a;
    ...
    return (0, import_jsx_runtime.jsx)(ActivityItem, { userId: authorId, children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", paddingTop: 1, children: (0, import_jsx_runtime.jsxs)(Text, { size: 1, muted: true, children: [
      ...
      " •",
      " ",
      (0, import_jsx_runtime.jsx)(Tooltip, { content: formattedDate, placement: "top-end", children: (0, import_jsx_runtime.jsx)(NoWrap, { children: (0, import_jsx_runtime.jsx)("time", { dateTime: createdAt, children: timeAgo }) }) })
    ] }) }) });
  },
...
function TasksSubscribers(props) {
  var _a, _b;
  const { value, onChange, path, currentUserId } = props, buttonText = (_a = value.subscribers) != null && _a.includes(currentUserId) ? "Unsubscribe" : "Subscribe", handleToggleSubscribe = (0, import_react.useCallback)(() => {
...
function TasksSubscriberAvatars(props) {
  const { subscriberIds: subscriberIdsProp } = props, subscriberIds = (0, import_react.useMemo)(() => (subscriberIdsProp == null ? void 0 : subscriberIdsProp.filter(Boolean)) || EMPTY_ARRAY$3, [subscriberIdsProp]);
...
function TasksActivityLog(props) {
  const { value, onChange, path, activityData = [] } = props, currentUser = useCurrentUser(), { title: workspaceTitle, basePath } = useWorkspace(), { comments: comments2, mentionOptions, operation, getComment } = useComments(), [commentToDeleteId, setCommentToDeleteId] = (0, import_react.useState)(null), [commentDeleteError, setCommentDeleteError] = (0, import_react.useState)(null), [commentDeleteLoading, setCommentDeleteLoading] = (0, import_react.useState)(false), loading = comments2.loading, taskComments = comments2.data.open, handleGetNotificationValue = (0, import_react.useCallback)(
  ...
  ), handleCommentCreate = (0, import_react.useCallback)(
    (message) => {
  ...
  ), handleCommentReply = (0, import_react.useCallback)(
    (nextComment) => {
    ...
    [operation, handleGetNotificationValue, onChange]
  ), handleCommentCreateRetry = (0, import_react.useCallback)(
    (id) => {
      const comment = getComment(id);
      if (!comment)
        return;
      ...
      onChange(set(notification.subscribers, ["subscribers"])), operation.create({
        ...
        message: comment.message,
        parentCommentId: comment.parentCommentId,
        reactions: comment.reactions || EMPTY_ARRAY$2,
        status: comment.status,
        threadId: comment.threadId,
        context: {
          notification
  ...
  ), handleCommentReact = (0, import_react.useCallback)(
    (id, reaction) => {
      operation.react(id, reaction);
    },
    [operation]
  ), handleDeleteCommentStart = (0, import_react.useCallback)((id) => setCommentToDeleteId(id), []), handleDeleteCommentCancel = (0, import_react.useCallback)(() => setCommentToDeleteId(null), []), handleDeleteCommentConfirm = (0, import_react.useCallback)(
    async (id) => {
      try {
    ...
    [operation]
  ), handleCommentEdit = (0, import_react.useCallback)(
    (id, next) => {
      operation.update(id, next);
    },
    [operation]
  ), activity = (0, import_react.useMemo)(() => {
  ...
  }, [activityData, taskComments]), { t } = useTranslation2(tasksLocaleNamespace), commentToDeleteIsParent = (0, import_react.useMemo)(() => {
    var _a;
...
function MentionUserMenuItem(props) {
  const { user, onSelect, pressed } = props, { t } = useTranslation2(tasksLocaleNamespace), handleSelect = (0, import_react.useCallback)(() => onSelect(user.id), [user, onSelect]);
...
function MentionsMenu({ onSelect, value = "" }) {
  const [searchTerm, setSearchTerm] = (0, import_react.useState)(""), { mentionOptions } = useMentionUser(), inputRef = (0, import_react.useRef)(null), options = [NO_ASSIGNEE_OPTION].concat(mentionOptions.data || []), handleSearchChange = (0, import_react.useCallback)((event) => {
  ...
  }, [options, searchTerm]), renderItem2 = (0, import_react.useCallback)(
...
function AssigneeCreateFormField(props) {
  const { value, onChange } = props, { mentionOptions } = useMentionUser(), mentionedUser = (0, import_react.useMemo)(
    () => {
      var _a;
      return (_a = mentionOptions.data) == null ? void 0 : _a.find((u) => u.id === value);
    },
    [mentionOptions.data, value]
  ), onSelect = (0, import_react.useCallback)((userId) => onChange(set(userId)), [onChange]), { t } = useTranslation2(tasksLocaleNamespace), displayText = (0, import_react.useMemo)(() => {
    if (value) {
...
function AssigneeEditFormField(props) {
  const { value, onChange, path } = props, subscribers = useFormValue(["subscribers"]), { mentionOptions } = useMentionUser(), mentionedUser = (0, import_react.useMemo)(
    () => {
      var _a;
      return (_a = mentionOptions.data) == null ? void 0 : _a.find((u) => u.id === value);
    },
    [mentionOptions.data, value]
  ), { t } = useTranslation2(tasksLocaleNamespace), onSelect = (0, import_react.useCallback)(
    (userId) => {
  ...
  ), displayText = (0, import_react.useMemo)(() => {
    if (value) {
      if (mentionOptions.loading)
        return (0, import_jsx_runtime.jsx)(TextSkeleton, { animated: true, style: { width: "10ch" } });
      if (mentionedUser)
  ...
  return (0, import_jsx_runtime.jsx)(
    AssigneeSelectionMenu,
    {
      onSelect,
      value,
      menuButton: (0, import_jsx_runtime.jsx)(StyledButton, { mode: "ghost", padding: 0, children: (0, import_jsx_runtime.jsx)(
        Tooltip,
        {
          content: t(value ? "form.input.assignee.user-assigned.tooltip" : "form.input.assignee.no-user-assigned.tooltip"),
          children: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, children: [
            (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 2, flex: 1, children: [
...
function DateEditFormField(props) {
  var _a;
  const { value, onChange, path } = props, { t: coreT } = useTranslation2(), { t } = useTranslation2(tasksLocaleNamespace), [pickerOpen, setPickerOpen] = (0, import_react.useState)(false), [popoverRef, setPopoverRef] = (0, import_react.useState)(null), buttonRef = (0, import_react.useRef)(null), dateFormatter = useDateTimeFormat({ dateStyle: "long" }), dueByeDisplayValue = (0, import_react.useMemo)(() => {
    if (!value)
      return { short: "----", full: "----" };
  ...
  const handleKeyUp = (0, import_react.useCallback)((e2) => {
    e2.key === "Escape" && setPickerOpen(false);
  }, []), handleClick = (0, import_react.useCallback)(() => setPickerOpen((p) => !p), []), calendarLabels = (0, import_react.useMemo)(() => getCalendarLabels(coreT), [coreT]), handleChange = (0, import_react.useCallback)(
    (nextDate) => {
      onChange(nextDate ? set(serialize(nextDate), path) : unset(path)), setPickerOpen(false);
    },
    [onChange, path]
  ), deserializedValue = deserialize(value), handleDeactivation = (0, import_react.useCallback)(() => {
    var _a2;
    ...
    Popover2,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(
        Button2,
        {
          ...
          ref: buttonRef,
          tooltipProps: {
            content: t(value ? "form.input.date.buttons.tooltip" : "form.input.date.buttons.empty.tooltip")
          }
        }
      )
    }
...
var DescriptionInputRoot = ut.div((props) => {
  const theme = getTheme_v2(props.theme), verticalPadding = props.$mode === "edit" ? theme.space[1] : theme.space[3], minHeight = props.$mode === "edit" ? 120 : 200;
  return at`
...
function DescriptionInput(props) {
  const {
    ...
    mode,
    inputProps: { onChange }
  } = props, value = _propValue, currentUser = useCurrentUser(), { mentionOptions } = useMentionUser(), handleChange = (0, import_react.useCallback)((next) => onChange(set(next)), [onChange]), [rootRef, setRootRef] = (0, import_react.useState)(null), [textBoxScrollHeight, setTextBoxScrollHeight] = (0, import_react.useState)(200), setTextboxHeight = (0, import_react.useCallback)((ref) => {
    const textBox = ref.querySelector('[role="textbox"]');
    if (!textBox)
      return;
    const height = textBox.scrollHeight;
    setTextBoxScrollHeight(height);
  }, []), handleSetRootRef = (0, import_react.useCallback)((ref) => {
    ref && (0, import_react.startTransition)(() => {
      setRootRef(ref);
    });
  }, []), { t } = useTranslation2(tasksLocaleNamespace);
  return (0, import_react.useEffect)(() => {
    rootRef && setTextboxHeight(rootRef);
  }, [value, setTextboxHeight, rootRef]), currentUser ? (0, import_jsx_runtime.jsx)(DescriptionInputRoot, { $mode: mode, ref: handleSetRootRef, $minHeight: textBoxScrollHeight, children: (0, import_jsx_runtime.jsx)(
    CommentInput,
    {
      expandOnFocus: false,
      currentUser,
...
var StatusMenuButton = (0, import_react.forwardRef)(function(props, ref) {
  var _a;
  const { t } = useTranslation2(tasksLocaleNamespace), { value, options, ...rest } = props, selectedOption = options.find((option) => option.value === value), icon = (_a = TASK_STATUS.find((status) => status.value === value)) == null ? void 0 : _a.icon;
  return (0, import_jsx_runtime.jsx)(
    Button2,
    {
      ...rest,
...
function StatusSelector(props) {
  const { value, onChange, options, path } = props, telemetry = useTelemetry(), handleStatusChange = (0, import_react.useCallback)(
    (next) => {
      onChange(set(next, path)), telemetry.log(TaskStatusChanged, { from: value, to: next });
    },
...
function Preview(props) {
  const { value, handleRemove } = props, documentId = value.document._ref, documentType = value.documentType, schemaType = useSchema().get(value.documentType), documentPresence = useDocumentPresence(documentId), { t } = useTranslation2(tasksLocaleNamespace), CardLink = (0, import_react.useMemo)(
    () => (0, import_react.forwardRef)(function(linkProps, ref) {
      return (0, import_jsx_runtime.jsx)(
        StyledIntentLink$1,
        {
          ...linkProps,
...
function TargetField(props) {
  const [open, setOpen] = (0, import_react.useState)(false), { dataset, projectId } = useWorkspace(), {
    mode,
    inputProps: { onChange },
    value: _propValue
  } = props, value = _propValue, handleItemSelect = (0, import_react.useCallback)(
    (item) => {
      onChange(
        set(
          getTargetValue({
    ...
    onChange(unset());
  }, [onChange]), handleOpenSearch = (0, import_react.useCallback)(() => {
    setOpen(true);
  }, [setOpen]), handleCloseSearch = (0, import_react.useCallback)(() => {
    setOpen(false);
  }, [setOpen]), handleKeyDown = (0, import_react.useCallback)((event) => {
...
function Title(props) {
  const { value, onChange, placeholder, path } = props, ref = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
...
function useTaskOperations() {
  const { client, createAddonDataset } = useAddonDataset(), currentUser = useCurrentUser(), handleCreate = (0, import_react.useCallback)(
    async (payload) => {
      if (!currentUser)
...
function useRemoveTask({ id, onError, onRemoved }) {
  const [removeStatus, setRemoveStatus] = (0, import_react.useState)("idle"), [showDialog, setShowDialog] = (0, import_react.useState)(false), [error, setError] = (0, import_react.useState)(null), operations = useTaskOperations(), handleRemove = (0, import_react.useCallback)(async () => {
    try {
  ...
  }, [id, operations, onError, onRemoved]), handleOpenDialog = (0, import_react.useCallback)(() => {
    setShowDialog(true);
  }, [setShowDialog]), handleCloseDialog = (0, import_react.useCallback)(() => {
    setShowDialog(false);
  }, [setShowDialog]);
  return {
    removeStatus,
...
function FormCreate(props) {
  const { onChange } = props, {
    ...
    setActiveTab,
    state: { viewMode }
  } = useTasksNavigation(), toast = useToast(), telemetry = useTelemetry(), [createMore, setCreateMore] = (0, import_react.useState)(false), handleCreateMore = (0, import_react.useCallback)(() => setCreateMore((p) => !p), []), value = props.value, onRemove = (0, import_react.useCallback)(() => {
    setViewMode({ type: "list" });
  }, [setViewMode]), { handleRemove, removeStatus } = useRemoveTask({ id: value._id, onRemoved: onRemove }), { t } = useTranslation2(tasksLocaleNamespace), handleCreate = (0, import_react.useCallback)(() => {
    ...
    ]), createMore ? setViewMode({ type: "create" }) : setActiveTab("subscribed"), telemetry.log(TaskCreated), toast.push({
      closable: true,
      status: "success",
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    props.renderDefault(props),
    (0, import_jsx_runtime.jsx)(Box, { paddingY: 5, children: (0, import_jsx_runtime.jsxs)(Flex, { paddingTop: 1, gap: 4, children: [
      value._rev && (0, import_jsx_runtime.jsx)(
        Button2,
        {
          onClick: handleRemove,
          mode: "bleed",
      ...
      (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 2, justify: "flex-end", flex: 1, children: [
...
function RemoveTaskDialog(props) {
  ...
  return showDialog ? (0, import_jsx_runtime.jsx)(
    Dialog2,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(Stack, { space: 3, children: (0, import_jsx_runtime.jsx)(Text, { as: "p", children: t("dialog.remove-task.body") }) })
    }
  ) : null;
}
...
function FormActionsMenu({ id, value }) {
  const { setViewMode, handleCopyLinkToTask } = useTasksNavigation(), { mode } = useTasksEnabled(), telemetry = useTelemetry(), onTaskRemoved = (0, import_react.useCallback)(() => {
    setViewMode({ type: "list" }), telemetry.log(TaskRemoved);
  }, [setViewMode, telemetry]), removeTask = useRemoveTask({ id, onRemoved: onTaskRemoved }), duplicateTask = (0, import_react.useCallback)(() => {
    setViewMode({ type: "duplicate", duplicateTaskValues: value }), telemetry.log(TaskDuplicated);
  }, [setViewMode, telemetry, value]), { t } = useTranslation2(tasksLocaleNamespace);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        ...
        menu: (0, import_jsx_runtime.jsxs)(Menu, { children: [
          (0, import_jsx_runtime.jsx)(
            MenuItem2,
            {
              ...
              tooltipProps: mode === "upsell" ? { content: t("menuitem.duplicate.upsell-tooltip") } : void 0,
              disabled: mode === "upsell"
            }
          ),
          (0, import_jsx_runtime.jsx)(
...
function FormEditInner(props) {
  var _a, _b, _c, _d, _e, _f;
  const statusField = props.schemaType.fields.find((f) => f.name === "status"), value = props.value, currentUser = useCurrentUser(), { t } = useTranslation2(tasksLocaleNamespace), activityData = useActivityLog(value).changes, handleChangeAndSubscribe = (0, import_react.useCallback)(
    (patch) => {
      const subscribers = value.subscribers || [];
  ...
  return (_a = props.value) != null && _a._id ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsx)(Card, { borderTop: true, marginTop: 3, children: (0, import_jsx_runtime.jsx)(
      FirstRow,
      {
        paddingBottom: 3,
        paddingTop: 4,
        ...
        justify: "flex-start",
        wrap: "wrap",
        children: (0, import_jsx_runtime.jsxs)(TooltipDelayGroupProvider, { children: [
          (0, import_jsx_runtime.jsx)(
            StatusSelector,
            {
...
function FormEdit(props) {
  const value = props.value, currentUser = useCurrentUser(), transformPatches = (0, import_react.useCallback)(
    (patches) => {
      if (!currentUser || patches.some((patch) => patch.path[0] === "subscribers") || patches.some((patch) => patch.path[0] === "context" && patch.path[1] === "notification"))
        return patches;
...
function TasksNotificationTargetInner(props) {
  var _a, _b, _c;
  const { inputProps } = props, { onChange } = inputProps, { target, _id, context, _rev } = useFormValue([]), { title: workspaceTitle, basePath } = useWorkspace(), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), imageBuilder = (0, import_react.useMemo)(() => (0, import_image_url.default)(client), [client]), documentId = (_b = (_a = target == null ? void 0 : target.document) == null ? void 0 : _a._ref) != null ? _b : "", documentType = (_c = target == null ? void 0 : target.documentType) != null ? _c : "", { isLoading: previewValuesLoading, value } = useDocumentPreviewValues({
    documentId,
    documentType
  }), targetContentTitle = (value == null ? void 0 : value.title) || null, imageUrl = isImageSource(value == null ? void 0 : value.media) ? imageBuilder.image(value.media).width(96).height(96).url() : null, notificationTarget = (0, import_react.useMemo)(() => {
    var _a2, _b2;
    const contextUrl = (_a2 = context == null ? void 0 : context.notification) != null && _a2.url ? new URL((_b2 = context == null ? void 0 : context.notification) == null ? void 0 : _b2.url) : "", currentUrl = new URL(`${window.location.origin}${basePath}/`), studioUrl = (
    ...
    return studioUrl.searchParams.set("sidebar", "tasks"), studioUrl.searchParams.set("selectedTask", _id), studioUrl.searchParams.set("viewMode", "edit"), {
      url: studioUrl.toString(),
      workspaceTitle,
  ...
  return (0, import_react.useEffect)(() => {
    documentId && documentType && previewValuesLoading || _rev && ((0, import_react_fast_compare.default)(context == null ? void 0 : context.notification, notificationTarget) || onChange(set(notificationTarget, ["notification"])));
...
function TasksAddonWorkspaceProviderInner({
  ...
  const apiHost = useClient({ apiVersion: API_VERSION }).config().apiHost, basePath = "", source = useSource(), addonDatasetConfig = (0, import_react.useMemo)(
    () => ({
      basePath,
  ...
  ), { workspaces } = (0, import_react.useMemo)(
...
function useTasksFormBuilder(options) {
  ...
  const { validation: validationRaw } = useValidationStatus(documentId, documentType), validation = useUnique(validationRaw), [focusPath, setFocusPath] = (0, import_react.useState)([]), [openPath, setOpenPath] = (0, import_react.useState)([]), [collapsedPaths, onSetCollapsedPath] = (0, import_react.useState)(), [collapsedFieldSets, onSetCollapsedFieldSets] = (0, import_react.useState)(), [fieldGroupState, onSetFieldGroupState] = (0, import_react.useState)(), [presence] = (0, import_react.useState)([]), handleFocus = (0, import_react.useCallback)(
    (nextFocusPath) => {
    ...
    setFocusPath([]);
  }, []), handleOnSetCollapsedPath = (0, import_react.useCallback)((path, collapsed) => {
    onSetCollapsedPath((prevState) => setAtPath(prevState, path, collapsed));
  }, []), handleOnSetCollapsedFieldSet = (0, import_react.useCallback)((path, collapsed) => {
    onSetCollapsedFieldSets((prevState) => setAtPath(prevState, path, collapsed));
  }, []), handleSetActiveFieldGroup = (0, import_react.useCallback)(
    (path, groupName) => onSetFieldGroupState((prevState) => setAtPath(prevState, path, groupName)),
    []
  ), { patch } = useDocumentOperation(documentId, documentType), patchRef = (0, import_react.useRef)(() => {
    throw new Error("Nope");
  });
  patchRef.current = (event) => {
    patch.execute(toMutationPatches(event.patches), initialValue);
  };
  const handleChange = (0, import_react.useCallback)((event) => patchRef.current(event), []), connectionState = useConnectionState(documentId, documentType), editState = useEditState(documentId, documentType), value = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published) || initialValue, formState = useFormState(tasksSchemaType, {
    value,
    ...
    fieldGroupState,
    validation
  }), ready = editState.ready && connectionState === "connected", patchChannel = (0, import_react.useMemo)(() => createPatchChannel(), []);
...
function TasksFormBuilder() {
  ...
  } = useTasksNavigation(), initialValue = (0, import_react.useMemo)(() => {
...
function EmptyStatusListState({ status }) {
  const {
    state: { activeTabId }
  } = useTasksNavigation(), { t } = useTranslation2(tasksLocaleNamespace), { heading, text } = HEADING_BY_STATUS[status][activeTabId];
...
function EmptyTasksListState() {
  const { activeDocument } = useTasks(), { mode } = useTasksEnabled(), {
    state: { activeTabId },
    setViewMode
  } = useTasksNavigation(), key = !activeDocument && activeTabId === "document" ? "noActiveDocument" : activeTabId, { heading, text } = EMPTY_TASK_LIST[key], { t } = useTranslation2(tasksLocaleNamespace), handleTaskCreate = (0, import_react.useCallback)(() => {
  ...
  return (0, import_jsx_runtime.jsx)(Root, { children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", gap: 3, align: "center", flex: 1, justify: "center", children: [
    (0, import_jsx_runtime.jsx)(AnimatedText, { size: 1, weight: "semibold", children: t(heading) }, key),
    (0, import_jsx_runtime.jsx)(Box, { paddingBottom: 6, paddingTop: 1, children: (0, import_jsx_runtime.jsx)(AnimatedText, { size: 1, align: "center", children: t(text) }, key) }),
    mode !== "upsell" && (0, import_jsx_runtime.jsx)(
      Button2,
      {
        icon: AddIcon,
...
function TasksStatus(props) {
  const operations = useTaskOperations(), { documentId, status } = props, [checkboxValue, setCheckboxValue] = (0, import_react.useState)(status === "closed"), [isLoading, setIsLoading] = (0, import_react.useState)(false), handleCheckboxChange = (0, import_react.useCallback)(
    async (event) => {
...
function TaskDueDate({ dueBy }) {
  const fullDateFormatter = useDateTimeFormat({ dateStyle: "medium" }), monthAndDayFormatter = useDateTimeFormat({ month: "short", day: "numeric" }), dayFormatter = useDateTimeFormat({ weekday: "long" }), dateOptions = (0, import_react.useMemo)(() => {
...
function TasksListItem(props) {
  const { assignedTo, title, dueBy, target, onSelect, documentId, status } = props, targetDocument = (0, import_react.useMemo)(() => getTargetDocumentMeta(target), [target]);
  return (0, import_jsx_runtime.jsxs)(Stack, { space: 3, children: [
    (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 1, children: [
      ...
      (0, import_jsx_runtime.jsx)(TasksUserAvatar, { user: assignedTo ? { id: assignedTo } : void 0, withTooltip: true })
    ] }),
...
function TasksList(props) {
  var _a, _b;
  const { items = EMPTY_ARRAY$1, onTaskSelect } = props, tasksByStatus = (0, import_react.useMemo)(
...
var TasksUpsellContext = (0, import_react.createContext)(null);
var FEATURE = "tasks";
...
function TasksUpsellProvider(props) {
  ...
  (0, import_react.useEffect)(() => {
    const sub = client.observable.request({
      ...
      next: (response) => {
        const data = response == null ? void 0 : response[0];
        if (data)
          try {
  ...
  return (0, import_jsx_runtime.jsxs)(TasksUpsellContext.Provider, { value: ctxValue, children: [
    props.children,
    upsellData && upsellDialogOpen && (0, import_jsx_runtime.jsx)(
      CommentsUpsellDialog,
      {
...
function useTasksUpsell() {
  return (0, import_react.useContext)(TasksUpsellContext) || {
    upsellData: null,
    handleOpenDialog: () => null,
    upsellDialogOpen: false,
    telemetryLogs: {
...
function TasksUpsellPanel() {
  ...
  return data ? (0, import_jsx_runtime.jsx)(
    CommentsUpsellPanel,
    {
      data,
      onPrimaryClick,
...
var FEEDBACK_FORM_LINK = "https://snty.link/tasks-feedback";
var Span = ut.span`
  margin-right: 0.2em;
`;
var Link = ut.a`
...
function LinkComponent(props) {
  return (0, import_jsx_runtime.jsxs)(Link, { href: FEEDBACK_FORM_LINK, target: "_blank", rel: "noreferrer", children: [
    (0, import_jsx_runtime.jsx)(Span, { children: props.children }),
    " ",
    (0, import_jsx_runtime.jsx)(LaunchIcon, {})
  ] });
}
function TasksListFeedbackFooter() {
  const { t } = useTranslation2(tasksLocaleNamespace);
  return (0, import_jsx_runtime.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime.jsx)(Translate, { i18nKey: "list.feedback.text", t, components: { Link: LinkComponent } }) }) });
}
var LIST_STYLES = {
  marginLeft: "-0.5em",
...
function TasksListTabs({ activeTabId, onChange }) {
  const { t } = useTranslation2(tasksLocaleNamespace), tabs = (0, import_react.useMemo)(
    () => [
      {
        id: "assigned",
    ...
    [t]
  ), handleTabChange = (0, import_react.useCallback)(
    (tab) => {
      onChange(tab.id);
    },
    [onChange]
...
function TasksActiveTabNavigation(props) {
  const { items: allItems } = props, { state: state2, setViewMode } = useTasksNavigation(), { selectedTask } = state2, items = allItems.filter((t2) => t2.status === "open"), currentItemIndex = items.findIndex((item) => item._id === selectedTask), goToPreviousTask = (0, import_react.useCallback)(() => {
  ...
  }, [currentItemIndex, items, setViewMode]), goToNextTask = (0, import_react.useCallback)(() => {
...
function TasksDraftsMenuItem(props) {
  const { isSelected, item, onSelect } = props, handleClick = (0, import_react.useCallback)(() => {
    onSelect(item._id);
...
function TasksHeaderDraftsMenu() {
  const { data } = useTasks(), { state: state2, setViewMode } = useTasksNavigation(), { viewMode, selectedTask } = state2, currentUser = useCurrentUser(), draftTasks = (0, import_react.useMemo)(() => currentUser != null && currentUser.id ? data.filter((task) => {
  ...
  }) : [], [data, selectedTask, currentUser == null ? void 0 : currentUser.id, viewMode]), handleSelectTask = (0, import_react.useCallback)(
    (id) => {
...
function TasksSidebarHeader(props) {
  const { items: allItems } = props, { mode } = useTasksEnabled(), { state: state2, setViewMode, handleCloseTasks } = useTasksNavigation(), { viewMode, activeTabId } = state2, handleTaskCreate = (0, import_react.useCallback)(() => {
    setViewMode({ type: "create" });
  }, [setViewMode]), handleGoBack = (0, import_react.useCallback)(() => {
    setViewMode({ type: "list" });
...
function TasksStudioSidebarInner() {
  const { mode } = useTasksEnabled(), { activeDocument, data, isLoading } = useTasks(), { state: state2, setActiveTab, setViewMode } = useTasksNavigation(), { activeTabId, viewMode, selectedTask } = state2, currentUser = useCurrentUser(), onTaskSelect = (0, import_react.useCallback)((id) => setViewMode({ type: "edit", id }), [setViewMode]), filteredList = (0, import_react.useMemo)(() => data.filter((item) => {
    var _a, _b;
  ...
  }), [activeDocument == null ? void 0 : activeDocument.documentId, activeTabId, data, currentUser]), content = (0, import_react.useMemo)(() => viewMode !== "list" ? (0, import_jsx_runtime.jsx)(TasksFormBuilder, {}, selectedTask) : isLoading ? (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "center", children: (0, import_jsx_runtime.jsx)(Spinner, {}) }) : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    mode === "upsell" && (0, import_jsx_runtime.jsx)(TasksUpsellPanel, {}),
    (0, import_jsx_runtime.jsx)(TasksList, { items: filteredList, onTaskSelect })
  ...
  return (0, import_jsx_runtime.jsxs)(RootCard, { display: "flex", height: "fill", flex: 1, overflow: "hidden", children: [
    ...
    viewMode === "list" && (0, import_jsx_runtime.jsx)(TasksListFeedbackFooter, {})
  ] });
}
...
function TaskCreateAction() {
  const { handleOpenTasks, setViewMode } = useTasksNavigation(), { enabled, mode } = useTasksEnabled(), { handleOpenDialog } = useTasksUpsell(), handleCreateTaskFromDocument = (0, import_react.useCallback)(() => {
    mode === "upsell" ? handleOpenDialog("document_action") : (handleOpenTasks(), setViewMode({ type: "create" }));
  }, [handleOpenTasks, setViewMode, mode, handleOpenDialog]), { t } = useTranslation2(tasksLocaleNamespace);
  return enabled ? {
    icon: TaskIcon,
...
function SetActiveDocumentInner(document2) {
  ...
  return (0, import_react.useEffect)(() => (documentId && isLast && documentType && (setActiveDocument == null || setActiveDocument({
...
function TasksFooterOpenTasks() {
  const { data, activeDocument } = useTasks(), { handleOpenTasks, setActiveTab } = useTasksNavigation(), { enabled } = useTasksEnabled(), mediaIndex = useMediaIndex(), pendingTasks = (0, import_react.useMemo)(
    () => data.filter((item) => {
      var _a;
    ...
    [activeDocument, data]
  ), handleOnClick = (0, import_react.useCallback)(() => {
...
var TasksStudioLayoutInner = (props) => {
  ...
  return enabled ? (0, import_jsx_runtime.jsx)(AddonDatasetProvider, { children: (0, import_jsx_runtime.jsx)(
    ConditionalWrapper,
    {
      condition: mode === "upsell",
      wrapper: (children) => (0, import_jsx_runtime.jsx)(TasksUpsellProvider, { children }),
      children: (0, import_jsx_runtime.jsx)(TasksProvider, { children: (0, import_jsx_runtime.jsx)(TasksNavigationProvider, { children: props.renderDefault(props) }) })
    }
  ) }) : props.renderDefault(props);
};
...
function TasksStudioNavbarInner(props) {
  const {
    ...
    handleCloseTasks,
    state: { isOpen }
  } = useTasksNavigation(), { t } = useTranslation2(tasksLocaleNamespace), handleClick = (0, import_react.useCallback)(() => {
    isOpen ? handleCloseTasks() : handleOpenTasks();
  }, [isOpen, handleOpenTasks, handleCloseTasks]), actions = (0, import_react.useMemo)(() => [
  ...
  ], [handleClick, isOpen, props == null ? void 0 : props.__internal_actions, t]);
...
function ChangesInspector(props) {
  const { onClose } = props, { documentId, schemaType, timelineError, timelineStore, value } = useDocumentPane(), scrollRef = (0, import_react.useRef)(null), diff2 = useTimelineSelector(timelineStore, (state2) => state2.diff), onOlderRevision = useTimelineSelector(timelineStore, (state2) => state2.onOlderRevision), selectionState = useTimelineSelector(timelineStore, (state2) => state2.selectionState), sinceTime = useTimelineSelector(timelineStore, (state2) => state2.sinceTime), loading = selectionState === "loading", isComparingCurrent = !onOlderRevision, { t } = useTranslation2("studio"), documentContext = (0, import_react.useMemo)(
    () => ({
      documentId,
      schemaType,
...
function DocumentNodePathBreadcrumbs(props) {
  ...
  return pathTitles.length ? (0, import_jsx_runtime.jsx)(Text, { size: 1, children: pathTitles.map((t, i) => (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-SNURIXJU.js")),
...
//# sourceMappingURL=chunk-TMPAP7CL.js.map
