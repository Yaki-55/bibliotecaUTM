    ...
    return (
        <div className='card'>
            <div className="InputContainer">
                <h1>Creador de QR <span style={{color:'gold'}}>UTM</span></h1>
                <input type="text" placeholder="Insertar link" value={value} onChange={e => setValue(e.target.value)} style={{ marginRight: '1rem' }} />
                <button onClick={handleClick} style={{ marginBottom: '1rem' }}>Usar API</button>
                <div className='color-picker'>
                    <label htmlFor="color">Para escoger color del QR: </label>
