      ...
      {addModalVisible && (
        <div className="modal">
          <div className="formularioLibro">
            ...
            <button type="submit" className="formulario__btn2" onClick={handleAddLibro}>Agregar</button>
          </div>
      ...
      {editModalVisible && (
        <div className="modal">
          <div className="formularioLibro">
            ...
            <button type="submit" className="formulario__btn2" onClick={handleEditLibro}>Guardar</button>
          </div>
        </div>
      )}
