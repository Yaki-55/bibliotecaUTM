        ...
        {modalVisible && (
          <div className="modal">
            <div className="modal-content">
              ...
              <div className="input-group">
                  <label>Autor:</label>
                  <input type="text" placeholder="Autor" value={newRevistaAuthor} onChange={handleAuthorChange} />
              </div>
              <div className="input-group">
                   <label>Año de Publicación:</label>
                  <input type="number" placeholder="Año de Publicación" value={newRevistaRedaccionDate} onChange={handleRedaccionDateChange} />
              </div>
              <div className="input-group">
            <label>ISSN:</label>
